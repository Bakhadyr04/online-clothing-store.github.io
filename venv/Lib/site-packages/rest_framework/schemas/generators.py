...
class EndpointEnumerator:
    ...
    def get_path_from_regex(self, path_regex):
        ...
        # Strip Django 2.0 converters as they are incompatible with uritemplate
        # format
    ...
    def get_allowed_methods(self, callback):
        ...
        if hasattr(callback, 'actions'):
            ...
            methods = [method.upper()
                       for method in actions & http_method_names]
        else:
            methods = callback.cls().allowed_methods

        return [method for method in methods if method not in (
            'OPTIONS', 'HEAD')]
...
class BaseSchemaGenerator:
    ...
    def _initialise_endpoints(self):
        if self.endpoints is None:
            inspector = self.endpoint_inspector_cls(
