    ...
    def get_path_fields(self, path, method):
        ...
        for variable in uritemplate.variables(path):
            ...
            if model is not None:
                ...
                if hasattr(
                        view, 'lookup_value_regex') and view.lookup_field == variable:
...
class ManualSchema(ViewInspector):
    ...
    def __init__(self, fields, description='', encoding=None):
        ...
        * `description`: String description for view. Optional.
        ...
        assert all(isinstance(f, coreapi.Field)
                   for f in fields), "`fields` must be a list of coreapi.Field instances"
        self._fields = fields
