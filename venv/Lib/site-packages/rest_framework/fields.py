...
def is_simple_callable(obj):
    ...
    if not (inspect.isfunction(obj) or inspect.ismethod(
            obj) or isinstance(obj, functools.partial)):
        return False
...
class Field:
    ...
    def __init__(self, *, read_only=False, write_only=False,
        ...
        # These are set up by `.bind()` when the field is added to a
        # serializer.
...
class IntegerField(Field):
    ...
    # allow e.g. '1.0' as an int, but not '1.2'
...
class DecimalField(Field):
    ...
    def __init__(self, max_digits, decimal_places, coerce_to_string=None, max_value=None, min_value=None,
        ...
        if rounding is not None:
            valid_roundings = [v for k, v in vars(
                decimal).items() if k.startswith('ROUND_')]
...
class DateTimeField(Field):
    ...
    def __init__(self, format=empty, input_formats=None,
                 default_timezone=None, **kwargs):
    ...
    def enforce_timezone(self, value):
        ...
        """
        field_timezone = self.timezone if hasattr(
            self, 'timezone') else self.default_timezone()
        ...
        if field_timezone is not None:
            ...
            try:
                ...
                # throw given an invalid datetime, so we need to specifically
                # check.
...
class DateField(Field):
    ...
    def to_internal_value(self, value):
        input_formats = getattr(
            self,
            'input_formats',
            api_settings.DATE_INPUT_FORMATS)
...
class TimeField(Field):
    ...
    def to_internal_value(self, value):
        input_formats = getattr(
            self,
            'input_formats',
            api_settings.TIME_INPUT_FORMATS)
...
class ListField(Field):
    ...
    def to_representation(self, data):
        ...
        return [self.child.to_representation(
            item) if item is not None else None for item in data]
