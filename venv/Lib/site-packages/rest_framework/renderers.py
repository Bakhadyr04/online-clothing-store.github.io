...
class HTMLFormRenderer(BaseRenderer):
    ...
    def render_field(self, field, parent_style):
        ...
        if style.get(
                'input_type') == 'datetime-local' and isinstance(field.value, str):
...
class BrowsableAPIRenderer(BaseRenderer):
    ...
    def _get_serializer(self, serializer_class,
    ...
    def get_context(self, data, accepted_media_type, renderer_context):
        ...
        raw_data_post_form = self.get_raw_data_form(
            data, view, 'POST', request)
        raw_data_put_form = self.get_raw_data_form(data, view, 'PUT', request)
        raw_data_patch_form = self.get_raw_data_form(
            data, view, 'PATCH', request)
...
class AdminRenderer(BrowsableAPIRenderer):
    ...
    def get_result_url(self, result, view):
        ...
        lookup_url_kwarg = getattr(
            view, 'lookup_url_kwarg', None) or lookup_field
    ...
    def render(self, data, accepted_media_type=None, renderer_context=None):
        if isinstance(data, coreapi.Document):
            ...
            return template.render(
                context, request=renderer_context['request'])
        else:
...
class OpenAPIRenderer(BaseRenderer):
    ...
    def render(self, data, media_type=None, renderer_context=None):
        # disable yaml advanced feature 'alias' for clean, portable, and
        # readable output
        ...
        Dumper.add_representer(
            datetime.timedelta,
            encoders.CustomScalar.represent_timedelta)
        return yaml.dump(data, default_flow_style=False,
                         sort_keys=False, Dumper=Dumper).encode('utf-8')
