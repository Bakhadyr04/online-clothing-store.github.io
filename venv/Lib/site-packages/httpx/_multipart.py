...
class DataField:
    ...
    def __init__(
        ...
        self.value: typing.Union[str, bytes] = (
            value if isinstance(
                value, bytes) else primitive_value_to_str(value)
        )
...
class FileField:
    ...
    def __init__(self, name: str, value: FileTypes) -> None:
        ...
        # since variable length tuples (especially of 4 elements) are quite
        # unwieldly
        ...
        if content_type is not None and not has_content_type_header:
            ...
            # requests does the opposite (it overwrites the header with the 3rd
            # tuple element)
