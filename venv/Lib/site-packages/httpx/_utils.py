...
class NetRCInfo:
    def __init__(
            self, files: typing.Optional[typing.List[str]] = None) -> None:
        if files is None:
    ...
    def get_credentials(
            self, host: str) -> typing.Optional[typing.Tuple[str, str]]:
...
class Logger(logging.Logger):
    ...
    def trace(self, message: str, *args: typing.Any,
...
def get_logger(name: str) -> Logger:
    ...
    if not _LOGGER_INITIALIZED:
        ...
        if log_level in ("DEBUG", "TRACE"):
            ...
            logger.setLevel(logging.DEBUG if log_level ==
                            "DEBUG" else TRACE_LOG_LEVEL)
...
def get_environment_proxies() -> typing.Dict[str, typing.Optional[str]]:
    ...
    no_proxy_hosts = [host.strip()
                      for host in proxy_info.get("no", "").split(",")]
...
def to_bytes(value: typing.Union[str, bytes],
