...
class Headers(typing.MutableMapping[str, str]):
    ...
    def keys(self) -> typing.KeysView[str]:
        return {key.decode(self.encoding): None for _,
                key, value in self._list}.keys()
    ...
    def get_list(self, key: str,
                 split_commas: bool = False) -> typing.List[str]:
        """
...
class Request:
    def __init__(
        ...
        *,
        ...
        if stream is None:
            content_type: typing.Optional[str] = self.headers.get(
                "content-type")
...
class Response:
    ...
    def text(self) -> str:
        if not hasattr(self, "_text"):
            ...
            if not content:
                ...
                self._text = "".join(
                    [decoder.decode(self.content), decoder.flush()])
        return self._text
    ...
    def json(self, **kwargs: typing.Any) -> typing.Any:
        if self.charset_encoding is None and self.content and len(
                self.content) > 3:
    ...
    @property
    def links(
            self) -> typing.Dict[typing.Optional[str], typing.Dict[str, str]]:
        """
...
class Cookies(typing.MutableMapping[str, str]):
    ...
    # type: ignore
    def update(self, cookies: typing.Optional[CookieTypes] = None) -> None:
