    ...
    * `url.query` is raw bytes, without URL escaping. A URL query string portion can only
    ...
    def copy_with(self, **kwargs: typing.Any) -> "URL":
        ...
        if "userinfo" in kwargs or "netloc" in kwargs:
            ...
            userinfo = (
                kwargs.pop(
                    "userinfo",
                    self.userinfo) or b"").decode("ascii")
        ...
        if "raw_path" in kwargs:
            # If "raw_path" is included, then split it into "path" and "query"
            # components.
            ...
            if "params" in kwargs:
                ...
                kwargs["query"] = None if not params else str(
                    QueryParams(params))
    ...
    def __repr__(self) -> str:
        ...
        if self._uri_reference.userinfo:
            ...
            # risk of unintended leakage, such as in debug information and
            # logging.
...
class QueryParams(typing.Mapping[str, str]):
    ...
    def __init__(
        ...
        if value is None or isinstance(value, (str, bytes)):
            value = value.decode("ascii") if isinstance(
    ...
    def merge(
            self, params: typing.Optional[QueryParamTypes] = None) -> "QueryParams":
        """
