...
class MiddlewareTest(TestCase):
    ...
    def test_user_is_not_set_on_create_view_not_logged_in(self):
        ...
        self.assertListEqual(
            [ph.history_user_id for ph in poll_history], [None])
    ...
    def test_user_is_not_set_on_update_view_when_not_logged_in(self):
        ...
        self.assertListEqual(
            [ph.history_user_id for ph in poll_history], [None, None])
    ...
    def test_user_is_unset_on_update_view_after_logging_out(self):
        ...
        self.assertListEqual(
            [ph.history_user_id for ph in poll_history], [
    ...
    def test_bucket_member_is_set_on_create_view_when_logged_in(self):
        ...
        self.assertListEqual(
            [h.history_user_id for h in history], [member1.id])
    ...
    def test_request_attr_is_deleted_after_each_response(self, func_mock):
        ...
        # The request variable should be deleted even if an exception was
        # raised
        assert_has_request_attr(False)
...
class MiddlewareBulkOpsTest(TestCase):
    ...
    def test_request_user_is_overwritten_by_default_user_on_bulk_create_view(
        ...
        self.client.force_login(self.user)
        self.client.post(
            reverse("poll-bulk-create-with-default-user"),
            data={})
        ...
        self.assertFalse(
            any(ph.history_user_id == self.user.id for ph in poll_history))
        self.assertFalse(
            any(ph.history_user_id is None for ph in poll_history))
    ...
    def test_user_is_not_set_on_bulk_update_view_when_not_logged_in(self):
        ...
        self.assertIsNone(poll_1.history.latest(
            "history_date").history_user_id)
        self.assertIsNone(poll_2.history.latest(
            "history_date").history_user_id)
    ...
    def test_request_user_is_overwritten_by_default_user_on_bulk_update(self):
        ...
        self.client.post(
            reverse("poll-bulk-update-with-default-user"),
            data={})

        self.assertIsNotNone(poll.history.latest(
            "history_date").history_user_id)
        self.assertNotEqual(
