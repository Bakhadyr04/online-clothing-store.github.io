...
class TestPopulateHistory(TestCase):
    ...
    def test_existing_objects(self):
        ...
        self.assertIn(
            populate_history.Command.EXISTING_HISTORY_FOUND,
            out.getvalue())
    ...
    def test_no_historical(self):
        ...
        self.assertIn(
            populate_history.Command.NO_REGISTERED_MODELS,
            out.getvalue())
...
class TestCleanDuplicateHistory(TestCase):
    ...
    def test_no_args(self):
        ...
        management.call_command(
            ...
            stderr=StringIO())
        self.assertIn(
            clean_duplicate_history.Command.COMMAND_HINT,
            out.getvalue())
...
class TestCleanOldHistory(TestCase):
    ...
    def test_no_historical(self):
        ...
        with replace_registry({"test_place": Place}):
            management.call_command(self.command_name, auto=True, stdout=out)
        self.assertIn(
            clean_old_history.Command.NO_REGISTERED_MODELS,
            out.getvalue())
