...
class PollWithManyToManyCustomHistoryID(models.Model):
    ...
    history = HistoricalRecords(
        m2m_fields=[places], history_id_field=models.UUIDField(
            default=uuid.uuid4)
    )
...
class PollWithSeveralManyToMany(models.Model):
    ...
    restaurants = models.ManyToManyField(
        "Restaurant", related_name="restaurants_poll")
...
class ModelWithCustomAttrOneToOneField(models.Model):
    poll = CustomAttrNameOneToOneField(
        Poll, models.CASCADE, attr_name="custom_poll")
...
class ModelWithSingleNoDBIndexUnique(models.Model):
    ...
    name_keeps_index = models.CharField(
