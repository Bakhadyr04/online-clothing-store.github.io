...
class Frame:
    ...
    def parse_frame_header(
            header: memoryview, strict: bool = False) -> Tuple["Frame", int]:
        """
...
class Padding:
    ...
    def __init__(self, stream_id: int, pad_length: int = 0,
                 **kwargs: Any) -> None:
...
class DataFrame(Padding, Frame):
    ...
    def __init__(self, stream_id: int, data: bytes = b'',
                 **kwargs: Any) -> None:
...
class RstStreamFrame(Frame):
    ...
    def __init__(self, stream_id: int, error_code: int = 0,
                 **kwargs: Any) -> None:
        super().__init__(stream_id, **kwargs)
...
class SettingsFrame(Frame):
    ...
    def __init__(self, stream_id: int = 0,
                 settings: Optional[Dict[int, int]] = None, **kwargs: Any) -> None:
        super().__init__(stream_id, **kwargs)
...
class PingFrame(Frame):
    ...
    def __init__(self, stream_id: int = 0,
                 opaque_data: bytes = b'', **kwargs: Any) -> None:
        super().__init__(stream_id, **kwargs)
...
class WindowUpdateFrame(Frame):
    ...
    def __init__(self, stream_id: int, window_increment: int = 0,
                 **kwargs: Any) -> None:
        super().__init__(stream_id, **kwargs)
...
class AltSvcFrame(Frame):
    ...
    def __init__(self, stream_id: int, origin: bytes = b'',
                 field: bytes = b'', **kwargs: Any) -> None:
        super().__init__(stream_id, **kwargs)
