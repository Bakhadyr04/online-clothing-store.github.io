...
class TestDistro:
    ...
    @pytest.mark.xfail(
        sys.version_info[:2] == (
            3, 12) and sys.version_info.releaselevel != 'final',
...
class TestRequirements:
    ...
    def testSetuptoolsProjectName(self):
        ...
        assert Requirement.parse(
            'setuptools == 0.7').project_name == 'setuptools'
        assert Requirement.parse(
            'setuptools == 0.7a1').project_name == 'setuptools'
        assert Requirement.parse(
            'setuptools >= 0.7').project_name == 'setuptools'
...
class TestParsing:
    ...
    def testSimpleRequirements(self):
        ...
        assert Requirement.parse(
            "FooBar==1.99a3") == Requirement("FooBar==1.99a3")
        with pytest.raises(ValueError):
...
class TestNamespaces:
    ...
    def test_two_levels_deep(self, symlinked_tmpdir):
        ...
        with pytest.warns(DeprecationWarning, match="pkg_resources.declare_namespace"):
            # pyright: ignore[reportMissingImports] # Temporary package for
            # test
            import pkg1
    ...
    def test_path_order(self, symlinked_tmpdir):
        ...
        for number, site in enumerate(site_dirs, 1):
            ...
            (subpkg /
             '__init__.py').write_text(vers_str %
