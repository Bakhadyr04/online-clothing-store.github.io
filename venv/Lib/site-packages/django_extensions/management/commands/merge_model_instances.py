...
def get_field_names(model):
    ...
    while not validated:
        first_field = int(
            input("Enter the number of the (first) field you would like to de-duplicate."))
        ...
        while not validated:
            ...
            if additional_field == "C":
                ...
                fields_to_deduplicate += [
                    available_fields[int(additional_field) - 1]]
                validated = True
            else:
                print("Invalid input. Please try again.")
    ...
    def handle(self, *args, **options):
        ...
        for instance in model.objects.all():
            ...
            try:
                ...
                primary_object, deleted_objects, deleted_objects_count = self.merge_model_instances(
                    primary_object, alias_objects)
                total_deleted_objects_count += deleted_objects_count

        print("Successfully deleted {} model instances.".format(
            ...
            for many_to_many_field in many_to_many_fields:
                ...
                for obj in related_objects.all():
                    try:
                        ...
                        # TODO: Allow the user to delete a duplicate 'through'
                        # model.
                        through_model = getattr(
                            alias_object, alias_varname).through
                        kwargs = {
