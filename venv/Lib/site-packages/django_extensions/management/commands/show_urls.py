...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if language is not None:
            ...
            self.LANGUAGES = [
                (code, name) for code, name in getattr(
                    settings, 'LANGUAGES', []) if code == language]
        else:
        ...
        for (func, regex, url_name) in view_functions:
            ...
            if format_style == 'json':
                views.append({"url": url, "module": module,
                             "name": url_name, "decorators": decorator})
            else:
    ...
    def extract_views_from_urlpatterns(
        ...
        for p in urlpatterns:
            if isinstance(p, (URLPattern, RegexURLPattern)):
                ...
                raise TypeError(
                    "%s does not appear to be a urlpattern object" %
                    p)
        return views
