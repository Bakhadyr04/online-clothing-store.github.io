...
def orm_item_locator(orm_obj):
    ...
    while hasattr(pk_value, "_meta") and hasattr(
            pk_value._meta, "pk") and hasattr(pk_value._meta.pk, "name"):
...
class Code:
    ...
    def get_import_lines(self):
        ...
        if self.imports:
            return ["from %s import %s" % (value, key)
...
class ModelCode(Code):
    ...
    def __init__(self, model, context=None, stdout=None,
                 stderr=None, options=None):
...
class InstanceCode(Code):
    ...
    def __init__(self, instance, id, context=None,
                ...
                if allowed_cycles <= 0:
                    ...
                    missing_models = [
                        ModelCode(
                            ...
                            stdout=self.stdout,
                            stderr=self.stderr,
                            options=self.options) for m in models]
...
def get_attribute_value(item, field, context,
                        force=False, skip_autofield=True):
