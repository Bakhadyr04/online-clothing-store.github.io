...
class EmailNotificationCommand(BaseCommand):
    ...
    def execute(self, *args, **options):
        ...
        try:
            ...
            if options['email_exception'] or getattr(
    ...
    def send_email_notification(
        ...
        if not include_traceback and not email_settings.get(
                'notification_level', 0):
        ...
        subject = email_settings.get(
            'subject', "Django extensions email notification.")
