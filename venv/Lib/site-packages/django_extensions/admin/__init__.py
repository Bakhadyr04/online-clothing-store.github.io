...
class ForeignKeyAutocompleteAdminMixin:
    ...
    autocomplete_limit = getattr(
        settings, 'FOREIGNKEY_AUTOCOMPLETE_LIMIT', None)
    ...
    def foreignkey_autocomplete(self, request):
        ...
        try:
            ...
            def to_string_function(x): return x.__str__()
        ...
        if search_fields and app_label and model_name and (query or object_pk):
            ...
            if query:
                for bit in query.split():
                    or_queries = [models.Q(**{construct_search(smart_str(field_name)): smart_str(
    ...
    def get_help_text(self, field_name, model_name):
        ...
        if searchable_fields:
            ...
            return _(
                'Use the left field to do %(model_name)s lookups in the fields %(field_list)s.') % help_kwargs
        return ''
    ...
    def formfield_for_dbfield(self, db_field, **kwargs):
        ...
        """
        if isinstance(
                db_field, models.ForeignKey) and db_field.name in self.related_search_fields:
