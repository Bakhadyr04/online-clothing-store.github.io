...
class Wheel:
    ...
    def is_compatible(self):
        ...
        return next((True for t in self.tags()
                    if t in _get_supported_tags()), False)
    ...
    def _convert_metadata(zf, destination_eggdir, dist_info, egg_info):
        ...
        wheel_v1 = parse_version(
            '1.0') <= wheel_version < parse_version('2.0dev0')
        if not wheel_v1:
            raise ValueError(
    ...
    def _fix_namespace_packages(egg_info, destination_eggdir):
        ...
        if os.path.exists(namespace_packages):
            namespace_packages = _read_utf8_with_fallback(
                namespace_packages).split()
