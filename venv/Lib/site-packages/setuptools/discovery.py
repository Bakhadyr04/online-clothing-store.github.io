...
class FlatLayoutPackageFinder(PEP420PackageFinder):
    ...
    def _looks_like_package(_path: StrPath, package_name: str) -> bool:
        ...
        # Consider PEP 561
        root_pkg_is_valid = names[0].isidentifier(
        ) or names[0].endswith("-stubs")
...
def remove_stubs(packages: list[str]) -> list[str]:
    ...
    ['a', 'a.b', 'b']
    """
    return [pkg for pkg in packages if not pkg.split(".")[
        0].endswith("-stubs")]
...
def construct_package_dir(
        packages: list[str], package_path: StrPath) -> dict[str, str]:
