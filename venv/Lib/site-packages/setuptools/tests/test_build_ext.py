...
class TestBuildExt:
    ...
    def test_get_outputs(self, tmpdir_cwd, monkeypatch):
        ...
        # Editable build: get_output_mappings should contain everything in
        # get_outputs
