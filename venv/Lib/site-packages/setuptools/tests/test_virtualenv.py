...
# the build process will still try to download `wheel`, see #3147 and
# #2986.
...
def test_pip_upgrade_from_source(
    ...
    venv.run(["pip", "install", "--no-cache-dir",
             "--upgrade", str(setuptools_sdist)])
