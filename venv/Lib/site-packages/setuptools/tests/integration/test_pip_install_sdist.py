...
# type: ignore[misc] # https://github.com/python/mypy/issues/16936
...
def test_install_sdist(package, version, tmp_path,
                       venv_python, setuptools_wheel):
    ...
    # but install fresh setuptools wheel to ensure the version under
    # development
