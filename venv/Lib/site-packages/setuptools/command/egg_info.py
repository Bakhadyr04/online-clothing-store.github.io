...
class InfoCommon:
    ...
    def _already_tagged(self, version: str) -> bool:
        ...
        # So in addition the regular tags, we have to search for the normalized
        # ones.
        return version.endswith(
            self.vtags) or version.endswith(self._safe_tags())

    def _safe_tags(self) -> str:
        # To implement this we can rely on `safe_version` pretending to be version 0
        # followed by tags. Then we simply discard the starting 0 (fake version
        # number)
        try:
...
class egg_info(InfoCommon, Command):
    ...
    def finalize_options(self) -> None:
        ...
        try:
            ...
            packaging.requirements.Requirement(
                spec % (self.egg_name, self.egg_version))
        ...
        self.egg_info = _normalization.filename_component(
            self.egg_name) + '.egg-info'
    ...
    def _get_egg_basename(self, py_version=PY_MAJOR, platform=None):
        ...
        return _egg_basename(
            self.egg_name, self.egg_version, py_version, platform)
