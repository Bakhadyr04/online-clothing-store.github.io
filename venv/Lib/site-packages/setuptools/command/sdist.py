...
class sdist(orig.sdist):
    ...
    def _add_defaults_build_sub_commands(self):
        ...
        files = (c.get_source_files()
                 for c in cmds if hasattr(c, "get_source_files"))
    ...
    def prune_file_list(self) -> None:
        ...
        # Prevent accidental inclusion of test-related cache dirs at the
        # project root
        sep = re.escape(os.sep)
        self.filelist.exclude_pattern(
            r"^(\.tox|\.nox|\.venv)" + sep, is_regex=True)
