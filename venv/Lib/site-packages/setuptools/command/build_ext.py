...
class build_ext(_build_ext):
    ...
    def _get_inplace_equivalent(
            self, build_py, ext: Extension) -> tuple[str, str]:
    ...
    def finalize_options(self) -> None:
        ...
        self.shlibs = [
            ext for ext in self.extensions if isinstance(
                ext, Library)]
        if self.shlibs:
    ...
    def setup_shlib_compiler(self):
        ...
        compiler.link_shared_object = link_shared_object.__get__(
            compiler)  # type: ignore[method-assign]
    ...
    def get_source_files(self) -> list[str]:
        return [
            *_build_ext.get_source_files(self), *self._get_internal_depends()]
    ...
    def get_outputs(self) -> list[str]:
        ...
        return sorted(_build_ext.get_outputs(
            self) + self.__get_stubs_outputs())
    ...
    def write_stub(self, output_dir, ext, compile=False) -> None:
        stub_file = os.path.join(
            output_dir, *ext._full_name.split('.')) + '.py'
