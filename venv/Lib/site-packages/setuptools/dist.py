...
class Distribution(_Distribution):
    ...
    # Used by build_py, editable_wheel and install_lib commands for legacy
    # namespaces
    ...
    def _finalize_requires(self):
        ...
        if self.extras_require:
            for extra in self.extras_require.keys():
                # Setuptools allows a weird "<name>:<env markers> syntax for
                # extras
                extra = extra.split(':')[0]
                if extra:
    ...
    def _setuptools_commands(self):
        try:
            ...
            # Avoid newer API for compatibility
    ...
    def _get_project_config_files(self, filenames: Iterable[StrPath] | None):
        ...
        tomlfiles = []
        standard_project_metadata = Path(
            self.src_root or os.curdir, "pyproject.toml")
    ...
    def parse_config_files(
        ...
        for filename in tomlfiles:
            pyprojecttoml.apply_configuration(
                self, filename, ignore_option_errors)
    ...
    # type: ignore[override] # Not doing complex overrides yet
