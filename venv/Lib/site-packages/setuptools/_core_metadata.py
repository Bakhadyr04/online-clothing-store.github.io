...
def rfc822_unescape(content: str) -> str:
    ...
    return '\n'.join(
        (lines[0].lstrip(), textwrap.dedent('\n'.join(lines[1:]))))
...
def read_pkg_file(self, file):
    ...
    if self.long_description is None and self.metadata_version >= Version(
            '2.1'):
...
def single_line(val):
    ...
    if '\n' in val:
        ...
        # due_date is undefined. Controversial change, there was a lot of push
        # back.
        val = val.strip().split('\n')[0]
    return val
