    ...
    def test_out_wrap_subok(self):
        ...
        for subok in (True, False):
            ...
            if subok:
                ...
                assert_(isinstance(r2, np.ndarray))
            ...
            if subok:
                ...
                assert_(isinstance(r1, np.ndarray))
...
class TestDivision:
    ...
    def test_floor_division_complex(self):
        ...
        x = np.array([.9 + 1j, -.1 + 1j, .9 + .5 *
                     1j, .9 + 2. * 1j], dtype=np.complex128)
...
class TestMaximum(_FilterInvalids):
    ...
    def test_strided_array(self):
        arr1 = np.array(
            [-4.0, 1.0, 10.0, 0.0, np.nan, -np.nan, np.inf, -np.inf])
