...
def enforce_url(value: Union["URL", bytes, str], *, name: str) -> "URL":
    ...
    seen_type = type(value).__name__
    raise TypeError(
        f"{name} must be a URL, bytes, or str, but got {seen_type}.")
...
class URL:
    ...
    def __bytes__(self) -> bytes:
        ...
        return b"%b://%b:%d%b" % (self.scheme, self.host,
...
class Request:
    ...
    def __init__(
        ...
        *,
        ...
        content: Union[bytes, Iterable[bytes],
                       AsyncIterable[bytes], None] = None,
