...
def merge_headers(
    ...
    override_headers = [] if override_headers is None else list(
        override_headers)
...
class AsyncHTTPProxy(AsyncConnectionPool):
    ...
    def __init__(
        ...
        proxy_auth: Optional[Tuple[Union[bytes, str],
        ...
        self._proxy_headers = enforce_headers(
            proxy_headers, name="proxy_headers")
