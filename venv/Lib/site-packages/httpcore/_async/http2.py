...
class AsyncHTTP2Connection(AsyncConnectionInterface):
    ...
    async def handle_async_request(self, request: Request) -> Response:
        ...
        async with self._state_lock:
            if self._state in (HTTPConnectionState.ACTIVE,
                               HTTPConnectionState.IDLE):
    ...
    async def _send_request_headers(
            self, request: Request, stream_id: int) -> None:
    ...
    async def _read_incoming_data(
        ...
        events: typing.List[h2.events.Event] = self._h2_state.receive_data(
            data)
    ...
    async def _wait_for_outgoing_flow(
            self, request: Request, stream_id: int) -> int:
        """
