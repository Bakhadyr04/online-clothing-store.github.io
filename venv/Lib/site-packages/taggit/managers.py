    ...
    def as_sql(self, compiler, connection):
        ...
        if len(self.content_types) == 1:
            ...
            extra_where = "{}.{} IN ({})".format(
                qn(self.alias), qn(self.col), ",".join(
                    ["%s"] * len(self.content_types))
            )
...
class _TaggableManager(models.Manager):
    ...
    def __init__(self, through, model, instance,
                 prefetch_cache_name, ordering=None):
        super().__init__()
...
class TaggableManager(RelatedField):
    ...
    def deconstruct(self):
        ...
        # Ref:
        # https://github.com/jazzband/django-taggit/issues/206#issuecomment-37578676
