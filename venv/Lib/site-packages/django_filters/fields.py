...
class BaseRangeField(BaseCSVField):
    ...
    default_error_messages = {"invalid_values": _(
        "Range query expects two values.")}
...
class ChoiceIteratorMixin:
    ...
    def choices(self, value):
        if DJANGO_50:
            ...
            super(
                ChoiceIteratorMixin,
                self.__class__).choices.__set__(
                self,
                value)
        else:
...
# Unlike their Model* counterparts, forms.ChoiceField and
# forms.MultipleChoiceField do not set empty_label
