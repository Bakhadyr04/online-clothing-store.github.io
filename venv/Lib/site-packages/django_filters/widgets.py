...
class SuffixedMultiWidget(forms.MultiWidget):
    ...
    def get_context(self, name, value, attrs):
        ...
        for subcontext, suffix in zip(
                context["widget"]["subwidgets"], self.suffixes):
    ...
    def value_omitted_from_data(self, data, files, name):
        return all(
            widget.value_omitted_from_data(
                data, files, self.suffixed(name, suffix))
            for widget, suffix in zip(self.widgets, self.suffixes)
        )
