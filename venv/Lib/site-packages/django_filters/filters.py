...
class MultipleChoiceFilter(Filter):
    ...
    def is_noop(self, qs, value):
        ...
        if self.extra.get("required") and len(
                value) == len(self.field.choices):
            return True
...
class BaseCSVFilter(Filter):
    ...
    def __init__(self, *args, **kwargs):
        kwargs.setdefault(
            "help_text",
            _("Multiple values may be separated by commas."))
        super().__init__(*args, **kwargs)
...
class LookupChoiceFilter(Filter):
    ...
    * ``field_class`` is an optional argument that allows you to set the inner
    ...
    def __init__(
        ...
        self.empty_label = kwargs.pop(
            "empty_label", settings.EMPTY_CHOICE_LABEL)
...
class OrderingFilter(BaseCSVFilter, ChoiceFilter):
    ...
    * ``field_labels`` is an optional argument that allows you to customize
    ...
    def normalize_fields(cls, fields):
        ...
        # convert iterable of values => iterable of pairs (field name, param
        # name)
        assert isinstance(
            fields, Iterable
