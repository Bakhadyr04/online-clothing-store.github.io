...
class FilterSetMetaclass(type):
    ...
    def get_declared_filters(cls, bases, attrs):
        ...
        # Default the `filter.field_name` to the attribute name on the
        # filterset
    ...
    def get_filters(cls):
        ...
        for field_name, lookups in fields.items():
            ...
            for lookup_expr in lookups:
                ...
                # If the filter is explicitly declared on the class, skip
                # generation
        ...
        # Allow Meta.fields to contain declared filters *only* when a
        # list/tuple
...
def filterset_factory(model, filterset=FilterSet, fields=None):
    ...
    return type(filterset)(
        str("%sFilterSet" %
            model._meta.object_name), (filterset,), {"Meta": Meta}
    )
