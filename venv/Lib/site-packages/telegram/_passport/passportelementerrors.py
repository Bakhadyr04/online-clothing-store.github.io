...
class PassportElementErrorFiles(PassportElementError):
    ...
    def __init__(self, type: str, file_hashes: str,
                 message: str, *, api_kwargs: JSONDict = None):
        # Required
        ...
        with self._unfrozen():
            ...
            self._id_attrs = (
                self.source,
                self.type,
                self.message) + tuple(file_hashes)
...
class PassportElementErrorUnspecified(PassportElementError):
    ...
    def __init__(self, type: str, element_hash: str,
                 message: str, *, api_kwargs: JSONDict = None):
        # Required
