...
class InputMedia(TelegramObject):
    ...
    def __init__(
        ...
        *,
        ...
        self.media: Union[str, InputFile, Animation,
                          Audio, Document, PhotoSize, Video] = media
    ...
    @staticmethod
    def _parse_thumb_input(
            thumb: Optional[FileInput]) -> Optional[Union[str, InputFile]]:
        ...
        return (
            parse_file_input(
                thumb,
                attach=True,
                local_mode=True) if thumb is not None else thumb
        )
...
class InputMediaAnimation(InputMedia):
    ...
    def __init__(
        ...
        *,
        ...
        with self._unfrozen():
            self.thumb: Optional[Union[str, InputFile]
                                 ] = self._parse_thumb_input(thumb)
