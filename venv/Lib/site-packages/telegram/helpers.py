...
def escape_markdown(text: str, version: int = 1,
...
def mention_markdown(user_id: Union[int, str],
                     name: str, version: int = 1) -> str:
    """
...
def effective_message_type(
        entity: Union["Message", "Update"]) -> Optional[str]:
    """
    ...
    if isinstance(entity, Message):
        ...
        raise TypeError(
            f"The entity is neither Message nor Update (got: {type(entity)})")
...
def create_deep_linked_url(
        bot_username: str, payload: str = None, group: bool = False) -> str:
    """
    ...
    if len(payload) > 64:
        raise ValueError(
            "The deep-linking payload must not exceed 64 characters.")
