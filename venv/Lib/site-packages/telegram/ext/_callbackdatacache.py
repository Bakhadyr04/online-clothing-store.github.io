...
class CallbackDataCache:
    ...
    * One for mapping the IDs of received callback queries to the cached objects
    ...
    def __init__(
        ...
        self._keyboard_data: MutableMapping[str, _KeyboardData] = LRUCache(
            maxsize=maxsize)
        self._callback_queries: MutableMapping[str, str] = LRUCache(
            maxsize=maxsize)
    ...
    def persistence_data(self) -> CDCData:
        ...
        # highly customized data structure at users trying to implement a
    ...
    def process_keyboard(
            self, reply_markup: InlineKeyboardMarkup) -> InlineKeyboardMarkup:
        ...
        # Built a new nested list of buttons by replacing the callback data if
        # needed
        buttons = [
            [
        ...
        if not keyboard_data.button_data:
            # If we arrive here, no data had to be replaced and we can return
            # the input
            return reply_markup
    ...
    @staticmethod
    def __put_button(callback_data: object,
                     keyboard_data: _KeyboardData) -> str:
        ...
        for row in message.reply_markup.inline_keyboard:
            for button in row:
                if button.callback_data:
                    ...
                    # update_callback_data makes sure that the _id_attrs are
                    # updated
                    ...
                    if not keyboard_uuid and not isinstance(
                            callback_data, InvalidCallbackData):
    ...
    def clear_callback_data(
            self, time_cutoff: Union[float, datetime] = None) -> None:
    ...
    def __clear(self, mapping: MutableMapping,
        ...
        to_drop = [key for key, data in mapping.items(
