...
class JobQueue(Generic[CCT]):
    ...
    @property
    def application(
            self) -> "Application[Any, CCT, Any, Any, Any, JobQueue[CCT]]":
    ...
    def run_repeating(
        ...
        first: Union[float, datetime.timedelta,
                     datetime.datetime, datetime.time] = None,
        last: Union[float,
                    datetime.timedelta,
                    datetime.datetime,
                    datetime.time] = None,
...
class Job(Generic[CCT]):
    ...
    async def _run(
        ...
        try:
            context = application.context_types.context.from_job(
                self, application)
            ...
            # This is internal logic of application - let's keep it private for
            # now
            application._mark_for_persistence_update(
                job=self)  # pylint: disable=protected-access
