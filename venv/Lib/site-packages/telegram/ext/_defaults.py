...
class Defaults:
    ...
    def parse_mode(self, value: object) -> NoReturn:
        raise AttributeError(
            "You can not assign a new value to parse_mode after initialization.")
    ...
    def quote(self, value: object) -> NoReturn:
        raise AttributeError(
            "You can not assign a new value to quote after initialization.")
    ...
    def tzinfo(self, value: object) -> NoReturn:
        raise AttributeError(
            "You can not assign a new value to tzinfo after initialization.")
