...
class Bot(TelegramObject, AsyncContextManager["Bot"]):
    ...
    # consider adding Paramspec from typing_extensions to properly fix this.
    ...
    def _insert_defaults(self, data: Dict[str, object]) -> None:
        ...
        # 2) replace all DefaultValue instances with the corresponding normal
        # value.
            ...
            if isinstance(val, InputMedia):
                ...
                for media in copy_list:
                    with media._unfrozen():
                        media.parse_mode = DefaultValue.get_value(
                            media.parse_mode)
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            raise InvalidToken(
                f"The token `{self._token}` was rejected by the server.") from exc
    ...
    async def send_sticker(
        ...
        *,
        ...
        data: JSONDict = {
            "chat_id": chat_id,
            "sticker": self._parse_file_input(
                sticker,
                Sticker)}
        return await self._send_message(
            "sendSticker",
        ...
        *,
        ...
        if caption and any(
            [
                ...
                # if parse_mode was set explicitly, even to None, error must be
                # raised
        ...
        if caption:
            ...
            # copy the list (just the references) to avoid mutating the
            # original list
            media = list(media)
    ...
    def _effective_inline_results(  # skipcq: PYL-R0201
        self,
        results: Union[
            Sequence["InlineQueryResult"], Callable[[int],
                                                    Optional[Sequence["InlineQueryResult"]]]
        ],
        ...
        if current_offset is not None:
            ...
            if callable(results):
                ...
                if len(results) > (current_offset_int + 1) * \
    ...
    def _insert_defaults_for_ilq_results(
            self, res: "InlineQueryResult") -> "InlineQueryResult":
        ...
        """
        # Copy the objects that need modification to avoid modifying the
        # original object
        copied = False
        ...
        if hasattr(res, "input_message_content") and res.input_message_content:
            if hasattr(res.input_message_content, "parse_mode"):
                ...
                with res._unfrozen():
                    res.input_message_content = copy.copy(
    ...
    async def get_user_profile_photos(
        ...
        *,
        ...
        return UserProfilePhotos.de_json(
            result, self)  # type: ignore[return-value]
    ...
    async def set_webhook(
        ...
        *,
        ...
        data: JSONDict = {
            ...
            "certificate": self._parse_file_input(certificate),
        }
    ...
    async def answer_web_app_query(
        ...
        *,
        ...
        return SentWebAppMessage.de_json(
            api_result, self)  # type: ignore[return-value]
    ...
    async def edit_chat_invite_link(
        ...
        *,
        ...
        """
        link = invite_link.invite_link if isinstance(
            invite_link, ChatInviteLink) else invite_link
        data: JSONDict = {
            "chat_id": chat_id,
            "invite_link": link,
            "expire_date": expire_date,
    ...
    async def set_chat_photo(
        ...
        *,
        ...
        data: JSONDict = {
            "chat_id": chat_id,
            "photo": self._parse_file_input(photo)}
        result = await self._post(
            "setChatPhoto",
            data,
            read_timeout=read_timeout,
...
CUSTOM_EMOJI_IDENTIFIER_LIMIT` custom emoji identifiers can be specified.
    ...
    async def get_my_default_administrator_rights(
        ...
        *,
        ...
        return ChatAdministratorRights.de_json(
            result, self)  # type: ignore[return-value]
