...
class RequestData:
    ...
    def __init__(self, parameters: List[RequestParameter] = None):
        ...
        self.contains_files: bool = any(
            param.input_files for param in self._parameters)

    @property
    def parameters(self) -> Dict[str, Union[str,
                                            int, List[Any], Dict[Any, Any]]]:
    ...
    def url_encoded_parameters(
            self, encode_kwargs: Dict[str, Any] = None) -> str:
    ...
    def parametrized_url(
            self, url: str, encode_kwargs: Dict[str, Any] = None) -> str:
        ...
        Args:
            ...
            encode_kwargs (Dict[:obj:`str`, any], optional): Additional keyword arguments to pass
                along to :func:`urllib.parse.urlencode`.
        """
        url_parameters = self.url_encoded_parameters(
