...
def to_float_timestamp(
    ...
    if reference_timestamp is None:
        ...
        raise ValueError(
            "t is an (absolute) datetime while reference_timestamp is not None")
    ...
    raise TypeError(
        f"Unable to convert {type(time_object).__name__} object to timestamp")
...
def from_timestamp(
        unixtime: Optional[int], tzinfo: dtm.tzinfo = UTC) -> Optional[dtm.datetime]:
    """
