...
class BotCommandScope(TelegramObject):
    ...
    * :class:`telegram.BotCommandScopeChatMember`
    ...
    def de_json(cls, data: Optional[JSONDict],
                bot: "Bot") -> Optional["BotCommandScope"]:
...
class BotCommandScopeAllChatAdministrators(BotCommandScope):
    ...
    def __init__(self, *, api_kwargs: JSONDict = None):
        super().__init__(
            type=BotCommandScope.ALL_CHAT_ADMINISTRATORS,
    ...
    def __init__(self, chat_id: Union[str, int],
        ...
        with self._unfrozen():
            self.chat_id: Union[str, int] = (
                chat_id if isinstance(
                    chat_id, str) and chat_id.startswith("@") else int(chat_id)
            )
...
class BotCommandScopeChatMember(BotCommandScope):
    ...
    def __init__(self, chat_id: Union[str, int],
                 user_id: int, *, api_kwargs: JSONDict = None):
