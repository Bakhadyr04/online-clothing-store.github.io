...
class SelectableFieldsExportForm(ExportForm):
    ...
    def _init_selectable_fields(
            self, resources: Iterable[ModelResource]) -> None:
        """
        Create `BooleanField(s)` for resource fields
        """
        self.resources = resources
        self.is_selectable_fields_form = True
        self.resource_fields = {resource.__name__: []
    ...
    def _get_field_label(self, resource: ModelResource,
                         field_name: str) -> str:
    ...
    def _create_boolean_fields(
            self, resource: ModelResource, index: int) -> None:
    ...
    @staticmethod
    def create_boolean_field_name(
            resource: ModelResource, field_name: str) -> str:
        """
    ...
    def _normalize_resource_fields(
            self, selected_resource: ModelResource) -> None:
        """
    ...
    def _validate_any_field_selected(self, resource) -> None:
        ...
        if not any(v for k, v in self.cleaned_data.items()
