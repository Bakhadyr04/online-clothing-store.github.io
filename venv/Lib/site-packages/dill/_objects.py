...
if HAS_CTYPES:
    ...
    _Struct._fields_ = [("_field", ctypes.c_int),
                        ("next", ctypes.POINTER(_Struct))]
...
# a['WrapperDescriptorType2'] = type.__dict__['__module__']#XXX:
# GetSetDescriptor
...
# XXX: empty vs non-empty #FIXME: list_iterator
...
# (see: inspect.getouterframes,getframeinfo)
...
a['RawDescriptionHelpFormatterType'] = argparse.RawDescriptionHelpFormatter(
    'PROG')
a['ArgDefaultsHelpFormatterType'] = argparse.ArgumentDefaultsHelpFormatter(
    'PROG')
z = a if IS_PYPY else x
