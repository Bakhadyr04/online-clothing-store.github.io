...
__all__ = [
    'baditems', 'badobjects', 'badtypes', 'code', 'errors', 'freevars',
...
# XXX: ugly: parse dis.dis for name after "<code object" in line and in
# globals?


# XXX: return dict of {__name__: obj} ?
...
def baditems(obj, exact=False, safe=False):  # XXX: obj=globals() ?
    ...
    if not hasattr(obj, '__iter__'):  # is not iterable
        return [
            j for j in (badobjects(obj, 0, exact, safe), ) if j is not None
        ]
...
def errors(obj, depth=0, exact=False, safe=False):
    ...
    if not depth:
        try:
            ...
            assert isinstance(pik, type(obj)), \
