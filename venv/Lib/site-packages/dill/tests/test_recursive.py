    ...
    if byref:
        try:
            ...
            raise AssertionError(
                'Copy of %s with byref=True should have given a warning!' %
                (obj,))
...
def test_circular_reference():
    ...
    assert type(obj4_copy) is type(
        obj4_copy).__init__.__closure__[0].cell_contents
    assert type(
        obj4_copy.b) is type(
        obj4_copy.b).__init__.__closure__[0].cell_contents
