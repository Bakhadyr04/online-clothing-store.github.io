...
class DiffTest(DiffMatchPatchTest):
    ...
    def testDiffCommonPrefix(self):
        ...
        # Non-null case.
        self.assertEqual(4, self.dmp.diff_commonPrefix("1234abcdef",
                                                       "1234xyz"))
    ...
    def testDiffCommonSuffix(self):
        ...
        # Non-null case.
        self.assertEqual(4, self.dmp.diff_commonSuffix("abcdef1234",
                                                       "xyz1234"))
    ...
    def testDiffCommonOverlap(self):
        ...
        # Overlap.
        self.assertEqual(3,
                         self.dmp.diff_commonOverlap("123456xxx", "xxxabcd"))
    ...
    def testDiffHalfMatch(self):
        ...
        self.assertEqual(
            ...
            self.dmp.diff_halfMatch("121231234123451234123121",
                                    "a1234123451234z"),
        )

        self.assertEqual(
            ("", "-=-=-=-=-=", "x", "", "x-=-=-=-=-=-=-="),
            self.dmp.diff_halfMatch("x-=-=-=-=-=-=-=-=-=-=-=-=",
                                    "xx-=-=-=-=-=-=-="),
        )

        self.assertEqual(
            ("-=-=-=-=-=", "", "", "y", "-=-=-=-=-=-=-=y"),
            self.dmp.diff_halfMatch("-=-=-=-=-=-=-=-=-=-=-=-=y",
                                    "-=-=-=-=-=-=-=yy"),
        )
    ...
    def testDiffLinesToChars(self):
        ...
        self.assertEqual(("\x01", "\x02", ["", "a", "b"]),
                         self.dmp.diff_linesToChars("a", "b"))
        ...
        lineList.insert(0, "")
        self.assertEqual((chars, "", lineList),
                         self.dmp.diff_linesToChars(lines, ""))
    ...
    def testDiffCleanupMerge(self):
        ...
        self.dmp.diff_cleanupMerge(diffs)
        self.assertEqual([(self.dmp.DIFF_INSERT, "ab"),
                          (self.dmp.DIFF_EQUAL, "ac")], diffs)
        ...
        self.dmp.diff_cleanupMerge(diffs)
        self.assertEqual([(self.dmp.DIFF_EQUAL, "ca"),
                          (self.dmp.DIFF_INSERT, "ba")], diffs)
        ...
        self.dmp.diff_cleanupMerge(diffs)
        self.assertEqual([(self.dmp.DIFF_DELETE, "abc"),
        ...
        self.dmp.diff_cleanupMerge(diffs)
        self.assertEqual([(self.dmp.DIFF_EQUAL, "xca"),
                          (self.dmp.DIFF_DELETE, "cba")], diffs)
        ...
        self.dmp.diff_cleanupMerge(diffs)
        self.assertEqual([(self.dmp.DIFF_INSERT, "a"),
                          (self.dmp.DIFF_EQUAL, "bc")], diffs)
    ...
    def testDiffCleanupSemanticLossless(self):
        ...
        self.dmp.diff_cleanupSemanticLossless(diffs)
        self.assertEqual([(self.dmp.DIFF_DELETE, "a"),
                          (self.dmp.DIFF_EQUAL, "aax")], diffs)
        ...
        self.dmp.diff_cleanupSemanticLossless(diffs)
        self.assertEqual([(self.dmp.DIFF_EQUAL, "xaa"),
                          (self.dmp.DIFF_DELETE, "a")], diffs)
    ...
    def testDiffCleanupSemantic(self):
        ...
        self.dmp.diff_cleanupSemantic(diffs)
        self.assertEqual([(self.dmp.DIFF_DELETE, "abcdef"),
                          (self.dmp.DIFF_INSERT, "cdfg")], diffs)
        ...
        self.dmp.diff_cleanupSemantic(diffs)
        self.assertEqual([(self.dmp.DIFF_DELETE, "AB_AB"),
                          (self.dmp.DIFF_INSERT, "1A2_1A2")], diffs)
        ...
        diffs = [(self.dmp.DIFF_DELETE, "abcxx"),
                 (self.dmp.DIFF_INSERT, "xxdef")]
        self.dmp.diff_cleanupSemantic(diffs)
        self.assertEqual([(self.dmp.DIFF_DELETE, "abcxx"),
                          (self.dmp.DIFF_INSERT, "xxdef")], diffs)

        # Overlap elimination.
        diffs = [(self.dmp.DIFF_DELETE, "abcxxx"),
                 (self.dmp.DIFF_INSERT, "xxxdef")]
        self.dmp.diff_cleanupSemantic(diffs)
        self.assertEqual(
            [
                (self.dmp.DIFF_DELETE, "abc"),
        ...
        diffs = [(self.dmp.DIFF_DELETE, "xxxabc"),
                 (self.dmp.DIFF_INSERT, "defxxx")]
        self.dmp.diff_cleanupSemantic(diffs)
        self.assertEqual(
            [
                (self.dmp.DIFF_INSERT, "def"),
    ...
    def testDiffCleanupEfficiency(self):
        ...
        self.dmp.diff_cleanupEfficiency(diffs)
        self.assertEqual(
            [(self.dmp.DIFF_DELETE, "abxyzcd"),
             (self.dmp.DIFF_INSERT, "12xyz34")],
            diffs,
        )
        ...
        self.dmp.diff_cleanupEfficiency(diffs)
        self.assertEqual([(self.dmp.DIFF_DELETE, "xcd"),
                          (self.dmp.DIFF_INSERT, "12x34")], diffs)
        ...
        self.assertEqual(
            [(self.dmp.DIFF_DELETE, "abxyzcd"),
             (self.dmp.DIFF_INSERT, "12xy34z56")],
            diffs,
        )
        ...
        self.dmp.diff_cleanupEfficiency(diffs)
        self.assertEqual(
            [(self.dmp.DIFF_DELETE, "abwxyzcd"),
             (self.dmp.DIFF_INSERT, "12wxyz34")],
            diffs,
        )
        self.dmp.Diff_EditCost = 4
    ...
    def testDiffDelta(self):
        ...
        diffs = self.dmp.diff_main("\U0001F64B\U0001F64B",
                                   "\U0001F64B\U0001F64C\U0001F64B")
        delta = self.dmp.diff_toDelta(diffs)
        self.assertEqual("=2\t+%F0%9F%99%8C\t=2", delta)
        self.assertEqual(
            diffs,
            self.dmp.diff_fromDelta("\U0001F64B\U0001F64B",
                                    "=2\t+%F0%9F%99%8C\t=2"),
        )
        ...
        self.assertEqual(
            ...
            self.dmp.diff_toDelta(
                self.dmp.diff_main("\U0001F170\U0001F171",
        ...
        self.assertEqual(
            ...
            self.dmp.diff_toDelta(
                self.dmp.diff_main("\U0001F171\U0001F170\U0001F171",
                                   "\U0001F170\U0001F171")),
        ...
        self.assertEqual(
            ...
            self.dmp.diff_toDelta(
                self.dmp.diff_main("\U0001F170\U0001F172\U0001F171",
                                   "\U0001F170\U0001F171")),
    ...
    def testDiffMain(self):
        ...
        # Equality.
        self.assertEqual([(self.dmp.DIFF_EQUAL, "abc")],
                         self.dmp.diff_main("abc", "abc", False))
        ...
        self.assertEqual(
            ...
            self.dmp.diff_main("Apples are a fruit.",
                               "Bananas are also fruit.", False),
        )
        ...
        self.assertEqual(
            ...
            self.dmp.diff_main("a [[Pennsylvania]] and [[New",
        ...
        a = "1234567890\n" * 13
        b = "abcdefghij\n" * 13
        self.assertEqual(self.dmp.diff_main(a, b, False),
                         self.dmp.diff_main(a, b, True))
        ...
        texts_textmode = self.diff_rebuildtexts(self.dmp.diff_main(
            a, b, False))
...
class MatchTest(DiffMatchPatchTest):
    ...
    def testMatchAlphabet(self):
        ...
        self.assertEqual({
            ...
            "b": 2,
            "c": 1
        }, self.dmp.match_alphabet("abc"))

        self.assertEqual({
            "a": 37,
            "b": 18,
            "c": 8
        }, self.dmp.match_alphabet("abcaba"))
    ...
    def testMatchBitap(self):
        ...
        self.assertEqual(2, self.dmp.match_bitap("abcdefghijk", "cdefxyhijk",
                                                 5))

        self.assertEqual(-1, self.dmp.match_bitap("abcdefghijk", "bxy", 1))

        # Overflow.
        self.assertEqual(2, self.dmp.match_bitap("123456789xx0", "3456789x0",
                                                 2))
        ...
        self.assertEqual(
            -1,
            self.dmp.match_bitap("abcdefghijklmnopqrstuvwxyz", "abcdefg", 24))

        self.assertEqual(
            0,
            self.dmp.match_bitap("abcdefghijklmnopqrstuvwxyz", "abcdxxefg", 1))

        self.dmp.Match_Distance = 1000  # Loose location.
        self.assertEqual(
            0, self.dmp.match_bitap("abcdefghijklmnopqrstuvwxyz", "abcdefg",
                                    24))
...
class PatchTest(DiffMatchPatchTest):
    ...
    def testPatchMake(self):
        ...
        # Character encoding.
        patches = self.dmp.patch_make("`1234567890-=[]\\;',./",
                                      '~!@#$%^&*()_+{}|:"<>?')
        self.assertEqual(
