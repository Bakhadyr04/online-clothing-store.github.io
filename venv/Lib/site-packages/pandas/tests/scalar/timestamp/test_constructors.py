...
class TestTimestampConstructorUnitKeyword:
    ...
    def test_construct_from_int_float_with_unit_out_of_bound_raises(self, typ):
        # GH#50870  make sure we get a OutOfBoundsDatetime instead of
        # OverflowError
    ...
    def test_constructor(self):
        ...
        for date_str, date_obj, expected in tests:
            ...
            for tz, offset in timezones:
                for result in [
                        Timestamp(date_str, tz=tz), Timestamp(date_obj, tz=tz)]:
...
@pytest.mark.parametrize("na_value",
                         [None, np.nan, np.datetime64("NaT"), NaT, NA])
