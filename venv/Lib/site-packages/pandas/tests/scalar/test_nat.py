...
@pytest.mark.parametrize("box", [TimedeltaIndex,
                         Series, TimedeltaArray._from_sequence])
...
@pytest.mark.parametrize("other",
                         [np.timedelta64(0, "ns"), np.datetime64("now", "ns")])
...
@pytest.mark.parametrize("other_and_type",
                         [("foo", "str"), (2, "int"), (2.0, "float")])
@pytest.mark.parametrize(
    "symbol_and_op",
