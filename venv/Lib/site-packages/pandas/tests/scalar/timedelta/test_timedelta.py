...
class TestNonNano:
    ...
    def unit(self, unit_str):
        # 7, 8, 9 correspond to second, millisecond, and microsecond,
        # respectively
...
class TestTimedeltas:
    ...
    def test_conversion(self):
        for td in [Timedelta(10, unit="d"), Timedelta(
                "1 days, 10:11:12.012345")]:
            pydt = td.to_pytimedelta()
            assert td == Timedelta(pydt)
            assert td == pydt
            assert isinstance(
                pydt, timedelta) and not isinstance(
                pydt, Timedelta)
