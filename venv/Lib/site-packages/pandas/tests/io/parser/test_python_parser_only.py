...
@pytest.mark.parametrize("bad_line_func",
                         [lambda x: ["2", "3"], lambda x: x[:2]])
...
def test_no_thousand_convert_for_non_numeric_cols(
        python_parser_only, dtype, expected):
    # GH#50270
    parser = python_parser_only
    data = """a;b;c
