...
class TestReadHtml:
    ...
    def test_dtype_backend(self, string_storage,
                           dtype_backend, flavor_read_html):
        # GH#50286
        df = DataFrame(
            {
    ...
    def test_banklist_header(self, banklist_data, datapath, flavor_read_html):
        ...
        df = flavor_read_html(
            banklist_data, match="Metcalf", attrs={
                "id": "table"})[0]
    ...
    def test_displayed_only(self, displayed_only, exp0,
                            exp1, flavor_read_html):
        # GH 20027
        data = """<html>
          <body>
            <table>
