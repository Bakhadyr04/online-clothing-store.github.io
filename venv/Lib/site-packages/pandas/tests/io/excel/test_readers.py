...
class TestReaders:
    ...
    def test_missing_file_raises(self, read_ext):
        ...
        # CI tests with other languages, translates to "No such file or
        # directory"
        match = "|".join(
            [
