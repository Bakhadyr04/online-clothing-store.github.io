...
class TestDataFrameFormatting:
    ...
    def test_repr_str_float_truncation(
            self, data, expected, using_infer_string):
        # GH#38708
...
class TestGenericArrayFormatter:
    ...
    def test_2d_extension_type(self):
        ...
        # Define a stub extension type with just enough code to run
        # Series.__repr__()
...
def test_filepath_or_buffer_arg(
    ...
    if filepath_or_buffer_id not in ["string",
                                     "pathlike"] and encoding is not None:
        with pytest.raises(
