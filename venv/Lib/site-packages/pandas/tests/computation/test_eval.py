...
class TestEval:
    ...
    def test_complex_cmp_ops(self, cmp1, cmp2, binop,
                             lhs, rhs, engine, parser):
    ...
    def test_binary_arith_ops(self, arith1, lhs, rhs, engine, parser):
        ...
        try:
            ...
            if engine == "numexpr":
                ...
                # can be replaced again by the assert_numpy_array_equal
                # statement
