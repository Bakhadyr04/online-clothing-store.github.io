...
class TestPeriodArrayLikeComparisons:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            9.5,
            2000,
            # specifically don't consider 2000 to match Period("2000", "D")
            False,
            None,
        ],
    )
    ...
    @pytest.mark.parametrize("other_box",
                             [list, np.array, lambda x: x.astype(object)])
...
class TestPeriodIndexComparisons:
    ...
    def test_parr_cmp_period_scalar(self, freq, box_with_array):
        # GH#13200
        base = PeriodIndex(
            ["2011-01", "2011-02", "2011-03", "2011-04"], freq=freq)
    ...
    def test_comp_nat(self, dtype):
        left = PeriodIndex(
            [Period("2011-01-01"), pd.NaT, Period("2011-01-03")])
...
class TestPeriodIndexArithmetic:
    ...
    def test_parr_sub_pi_mismatched_freq(
            self, box_with_array, box_with_array2):
        rng = period_range("1/1/2000", freq="D", periods=5)
    ...
    def test_pi_add_offset_array(self, box):
        ...
        expected = PeriodIndex(
            [Period("2015Q2"), Period("2015Q4")]).astype(object)
    ...
    def test_pi_add_offset_n_gt1(self, box_with_array, transpose):
        ...
        expected = tm.box_expected(
            expected, box_with_array, transpose=transpose)
    ...
    def test_parr_add_timedeltalike_minute_gt1(
            self, three_days, box_with_array):
        ...
        expected = PeriodIndex(
            ["2014-05-04", "2014-05-06", "2014-05-08"], freq="2D")
        expected = tm.box_expected(expected, box_with_array)
        ...
        # subtraction
        expected = PeriodIndex(
            ["2014-04-28", "2014-04-30", "2014-05-02"], freq="2D")
        expected = tm.box_expected(expected, box_with_array)
        result = rng - other
        tm.assert_equal(result, expected)
    ...
    @pytest.mark.parametrize("freqstr",
                             ["5ns", "5us", "5ms", "5s", "5min", "5h", "5d"])
    def test_parr_add_timedeltalike_tick_gt1(
            self, three_days, freqstr, box_with_array):
        # GH#23031 adding a time-delta-like offset to a PeriodArray that has
...
class TestPeriodIndexSeriesMethods:
    ...
    def test_pi_ops_array_int(self):
        ...
        def f(x): return x + np.array([1, 2, 3, 4])
        exp = PeriodIndex(
            ["2011-02", "2011-04", "NaT", "2011-08"], freq="M", name="idx"
        )
        self._check(idx, f, exp)

        def f(x): return np.add(x, np.array([4, -1, 1, 2]))
        exp = PeriodIndex(
        ...
        def f(x): return np.subtract(x, np.array([3, 2, 3, -2]))
        exp = PeriodIndex(
    ...
    def test_pi_ops_offset(self):
        ...
        def f(x): return x + pd.offsets.Day()
        exp = PeriodIndex(
        ...
        def f(x): return x + pd.offsets.Day(2)
        exp = PeriodIndex(
