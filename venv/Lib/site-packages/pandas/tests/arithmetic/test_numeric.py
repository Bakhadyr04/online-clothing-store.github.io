...
class TestNumericComparisons:
    ...
    def test_numeric_cmp_string_numexpr_path(
            self, box_with_array, monkeypatch):
        # GH#36377, GH#35700
        box = box_with_array
...
class TestNumericArraylikeArithmeticWithDatetimeLike:
    ...
    def test_numeric_arr_mul_tdscalar(
            self, scalar_td, numeric_idx, box_with_array):
        # GH#19333
        box = box_with_array
        index = numeric_idx
    ...
    def test_numeric_arr_rdiv_tdscalar(
            self, three_days, numeric_idx, box_with_array):
        box = box_with_array
...
class TestNumericArithmeticUnsorted:
    ...
    @pytest.mark.parametrize("idx1",
                             [RangeIndex(0, 10, 1), RangeIndex(0, 20, 2)])
    @pytest.mark.parametrize("idx2",
                             [RangeIndex(0, 10, 1), RangeIndex(0, 20, 2)])
