...
class TestDataFrameConcat:
    def test_concat_multiple_frames_dtypes(self):
        # GH#2759
        df1 = DataFrame(data=np.ones((10, 2)), columns=[
    ...
    def test_concat_named_keys(self):
        ...
        concatted_named_from_names = concat(
    ...
    def test_concat_axis_parameter(self):
        ...
        tm.assert_frame_equal(
            concatted_columns_series,
            expected_columns_series)
    ...
    def test_concat_dataframe_keys_bug(self, sort):
        t1 = DataFrame(
            {"value": Series([1, 2, 3], index=Index(
                ["a", "b", "c"], name="id"))}
        )
        t2 = DataFrame(
    ...
    def test_concat_duplicates_in_index_with_keys(self):
        ...
        tm.assert_index_equal(
            result.index.levels[1], Index([1, 3], name="date"))
    ...
    def test_outer_sort_columns(self):
        ...
        expected = DataFrame(
            {0: [1.0, np.nan], "A": [0, 100], "B": [1.0, np.nan]})
        tm.assert_frame_equal(result, expected)
