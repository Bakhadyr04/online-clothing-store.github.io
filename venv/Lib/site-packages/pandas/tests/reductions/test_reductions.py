...
class TestReductions:
    ...
    def test_ops(self, opname, obj):
        ...
        if getattr(obj, "tz", None) is not None:
            # We need to de-localize before comparing to the numpy-produced
            # result
...
class TestSeriesMode:
    ...
    def test_mode_str_obj(self, dropna, expected1, expected2, expected3):
        ...
        expected2 = Series(
            expected2,
            dtype=None if expected2 == ["bar"] else object)
    ...
    def test_mode_mixeddtype(self, dropna, expected1, expected2):
        ...
        expected = Series(
            expected2,
            dtype=None if expected2 == ["foo"] else object)
        tm.assert_series_equal(result, expected)
