...
class TestTimestampEquivDateRange:
    ...
    def test_date_range_timestamp_equiv_from_datetime_instance(self):
        ...
        timestamp_instance = date_range(
            datetime_instance, periods=1, freq="D")[0]
...
class TestDateRanges:
    ...
    @pytest.mark.slow
    @pytest.mark.parametrize(
        "s_ts, e_ts", [("2262-02-23", "1969-11-14"),
                       ("1970-02-01", "1677-10-22")]
    )
    ...
    def test_range_tz_dateutil(self):
        ...
        def tz(x): return maybe_get_tz("dateutil/" + x)
...
class TestDateRangeNonNano:
    ...
    def test_date_range_freq_matches_reso(self):
        ...
        dti = date_range(
            ...
            unit="us")
        rng = np.arange(
            1_451_606_400_000_000,
            1_451_606_401_000_001,
            dtype=np.int64)
    ...
    def test_date_range_freq_lower_than_endpoints(self):
        ...
        rng = np.array(
            [start.as_unit("us")._value, end.as_unit(
                "us")._value], dtype=np.int64
        )
...
class TestDateRangeNonTickFreq:
    ...
    def test_date_range_with_custom_holidays(self, unit):
        # GH#30593
        freq = offsets.CustomBusinessHour(
            start="15:00", holidays=["2020-11-26"])
        result = date_range(
            start="2020-11-25 15:00",
            periods=4,
            freq=freq,
            unit=unit)
        expected = DatetimeIndex(
    ...
    def test_date_range_business_hour_short(self, unit):
        # GH#49835
        idx4 = date_range(
            start="2014-07-01 10:00",
            freq="bh",
            periods=1,
            unit=unit)
        expected4 = DatetimeIndex(
            ["2014-07-01 10:00"],
            dtype=f"M8[{unit}]",
            freq="bh")
    ...
    def test_date_range_semi_month_begin(self, unit):
        ...
        result = date_range(
            start=dates[0], end=dates[-1], freq="SMS", unit=unit)
    ...
    def test_date_range_semi_month_end(self, unit):
        ...
        # ensure generating a range with DatetimeIndex gives same result
        result = date_range(
            start=dates[0], end=dates[-1], freq="SME", unit=unit)
