...
class TestSlicing:
    ...
    def test_return_type_doesnt_depend_on_monotonicity(self):
        # GH#24892 we get Series back regardless of whether our DTI is
        # monotonic
    ...
    def test_partial_slicing_with_multiindex(self):
        ...
        # partial string indexing on first level, scalar indexing on the other
        # two
