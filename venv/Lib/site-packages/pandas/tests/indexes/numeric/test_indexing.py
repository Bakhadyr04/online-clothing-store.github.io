...
@pytest.fixture
def index_large():
    # large values used in Index[uint64] tests where no compat needed with
    # Int64/Float64
...
class TestGetLoc:
    ...
    @pytest.mark.parametrize("vals",
                             [[1], [1.0], [Timestamp("2019-12-31")], ["test"]])
    ...
    def test_get_loc_numericindex_none_raises(self, dtype):
        # case that goes through searchsorted and key is non-comparable to
        # values
