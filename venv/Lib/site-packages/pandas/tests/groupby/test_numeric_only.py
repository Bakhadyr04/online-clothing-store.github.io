...
def test_axis1_numeric_only(request, groupby_func,
    ...
    if has_arg and numeric_only is True:
        ...
        msg = "|".join(
            [
                ...
                # On PY39 message is "a number"; on PY310 and after is "a real
                # number"
...
def test_deprecate_numeric_only_series(dtype, groupby_func, request):
    ...
    # that succeed should not be allowed to fail (without deprecation, at
    # least)
