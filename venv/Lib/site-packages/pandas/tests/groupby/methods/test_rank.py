...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("dense", True, True, [1.0 / 3.0, 1.0 /
         3.0, 3.0 / 3.0, 1.0 / 3.0, 2.0 / 3.0]),
        ("dense", False, False, [3.0, 3.0, 1.0, 3.0, 2.0]),
        ("dense", False, True, [3.0 / 3.0, 3.0 /
         3.0, 1.0 / 3.0, 3.0 / 3.0, 2.0 / 3.0]),
    ],
)
...
@pytest.mark.parametrize(
    "pct,exp", [(False, [3.0, 3.0, 3.0, 3.0, 3.0]),
                (True, [0.6, 0.6, 0.6, 0.6, 0.6])]
)
...
def test_groupby_axis0_rank_axis1():
    ...
    expected = concat(
        [df.loc["a"].rank(axis=1), df.loc["b"].rank(axis=1)], axis=0)
