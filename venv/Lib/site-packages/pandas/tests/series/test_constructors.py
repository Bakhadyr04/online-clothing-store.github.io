...
class TestSeriesConstructors:
    ...
    def test_unparsable_strings_with_dt64_dtype(self):
        # pre-2.0 these would be silently ignored and come back with object
        # dtype
        vals = ["aa"]
    ...
    def test_constructor_unsigned_dtype_overflow(
            self, any_unsigned_int_numpy_dtype):
        # see gh-15832
        if np_version_gt2:
            msg = (
    ...
    @pytest.mark.parametrize("interval_constructor",
                             [IntervalIndex, IntervalArray])
    ...
    def test_construction_consistency(self):
        ...
        with tm.assert_produces_warning(None):
            # one suggested alternative to the deprecated (changed in 2.0)
            # usage
