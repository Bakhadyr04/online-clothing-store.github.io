...
class TestSeriesNLargestNSmallest:
    ...
    def test_nsmallest_nlargest(self, s_main_dtypes_split):
        ...
        tm.assert_series_equal(ser.nlargest(len(ser)),
                               ser.iloc[[4, 0, 1, 3, 2]])
        tm.assert_series_equal(ser.nlargest(
            len(ser) + 1), ser.iloc[[4, 0, 1, 3, 2]])
    ...
    def test_nlargest_boundary_float(self, nselect_method, float_numpy_dtype):
        ...
        min_2nd, max_2nd = np.nextafter(
            [min_val, max_val], 0, dtype=float_numpy_dtype)
