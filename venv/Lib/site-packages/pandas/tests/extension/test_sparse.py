...
def data_for_compare(request):
    return SparseArray([0, 0, np.nan, -2, -1, 4, 2, 3,
                       0, 0], fill_value=request.param)
...
class TestSparseArray(base.ExtensionTests):
    ...
    def test_array(self, data_for_compare: SparseArray,
                   comparison_op, request):
    ...
    def test_sparse_array(
            self, data_for_compare: SparseArray, comparison_op, request):
