...
class BaseMethodsTests:
    ...
    def test_argmin_argmax(self, data_for_sorting,
                           data_missing_for_sorting, na_value):
        # GH 24382
    ...
    # Subclasses can override if we expect e.g Sparse[bool], boolean,
    # pyarrow[bool]
    ...
    def test_searchsorted(self, data_for_sorting, as_series):
        if data_for_sorting.dtype._is_boolean:
            return self._test_searchsorted_bool_dtypes(
                data_for_sorting, as_series)
