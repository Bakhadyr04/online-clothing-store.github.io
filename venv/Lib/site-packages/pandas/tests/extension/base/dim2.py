...
class Dim2CompatTests:
    ...
    def test_reductions_2d_axis_none(self, data, method):
        ...
        try:
            ...
            # if the 1D reduction is invalid, the 2D reduction should be as
            # well
            err_expected = err
            try:
        ...
        if err_result is not None or err_expected is not None:
            assert isinstance(err_result, type(err_expected))
            return
    ...
    def test_reductions_2d_axis0(self, data, method, min_count):
        ...
        try:
            ...
            try:
                ...
                assert isinstance(err, type(err2))
                return
            else:
...
class NDArrayBacked2DTests(Dim2CompatTests):
    ...
    def test_copy_order(self, data):
        # We should be matching numpy semantics for the "order" keyword in
        # 'copy'
        arr2d = data.repeat(2).reshape(-1, 2)
