...
def test_expanding_apply_consistency_sum_nans(
        request, all_data, min_periods, f):
    if f is np.sum:
...
def test_expanding_consistency_constant(consistent_data, min_periods):
    ...
    corr_x_x = consistent_data.expanding(
        min_periods=min_periods).corr(consistent_data)
