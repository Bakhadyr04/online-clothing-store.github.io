...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "right",
            False,
            DataFrame({"a": [np.nan, 10, 20], "b": [
                      300, 100, 200]}, index=[3, 1, 2]),
        ),
        (
            "right",
            True,
            DataFrame({"a": [10, 20, np.nan], "b": [
                      100, 200, 300]}, index=[1, 2, 3]),
        ),
        (
            "outer",
            False,
...
class TestDataFrameJoin:
    ...
    def test_join_multiindex_leftright(self):
        ...
        tm.assert_frame_equal(df2.join(df1, how="right"),
                              exp[["value2", "value1"]])
        ...
        tm.assert_frame_equal(df2.join(df1, how="left"),
                              exp[["value2", "value1"]])
