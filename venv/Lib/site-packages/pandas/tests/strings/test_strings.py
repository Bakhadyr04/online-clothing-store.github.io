...
def test_empty_str_methods(any_string_dtype):
    ...
    tm.assert_series_equal(
        empty_object, empty.str.partition(
            "a", expand=False))
    tm.assert_frame_equal(empty_df, empty.str.partition("a"))
    tm.assert_series_equal(
        empty_object, empty.str.rpartition(
            "a", expand=False))
...
def test_index(method, sub, start, end, index_or_series,
               any_string_dtype, expected):
    obj = index_or_series(
