...
class TestCategoricalConstructors:
    ...
    def test_from_codes_nullable_int_categories(
            self, any_numeric_ea_dtype, validate):
        # GH#39649
    ...
    def test_from_codes_validate(self, validate):
        ...
        if validate:
            ...
            # passes, though has incorrect codes, but that's the user
            # responsibility
            Categorical.from_codes([4, 5], dtype=dtype, validate=validate)
    ...
    def test_from_codes_with_nullable_int(self):
        ...
        expected = Categorical.from_codes(
            codes.to_numpy(int), categories=categories)
    ...
    def test_interval(self):
        ...
        tm.assert_numpy_array_equal(
            cat.codes, np.array([1, 2, 0], dtype="int8"))
        tm.assert_index_equal(cat.categories, idx)
