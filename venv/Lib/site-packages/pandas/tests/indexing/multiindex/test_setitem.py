...
class TestMultiIndexSetItem:
    def check(self, target, indexers, value,
              compare_fn=assert_equal, expected=None):
    ...
    # all NaNs -> doesn't work in the "split" path (also for BlockManager
    # actually)
