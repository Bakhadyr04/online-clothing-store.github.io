...
class TestCategoricalIndex:
    ...
    def test_slicing_and_getting_ops(self):
        ...
        # "j",: | 2,:
        exp_row = Series(["b", 3], index=["cats", "values"],
                         dtype="object", name="j")
    ...
    def test_slicing_doc_examples(self):
        ...
        expected = Series(["category", "int64"], [
                          "cats", "values"], dtype=object)
        tm.assert_series_equal(result, expected)
    ...
    def test_loc_getitem_listlike_unused_category(self, df2):
        ...
        # listlike containing an element in the categories but not in the
        # values
    ...
    def test_loc_listlike_dtypes(self):
        ...
        exp_index = CategoricalIndex(
            ["a", "a", "b"], categories=index.categories)
    ...
    def test_loc_listlike_dtypes_unused_category(self):
        ...
        exp = DataFrame(
            ...
            index=CategoricalIndex(
                ["a", "a", "a", "a", "b"], categories=list("abcde")),
        )
        tm.assert_frame_equal(res, exp, check_index_type=True)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            *(np.array([1, 2, 3], dtype=dtype)
              for dtype in tm.ALL_INT_NUMPY_DTYPES),
            # numpy floats
            *(np.array([1.5, 2.5, 3.5], dtype=dtyp)
              for dtyp in tm.FLOAT_NUMPY_DTYPES),
            # numpy object
            np.array([1, "b", 3.5], dtype=object),
            # pandas scalars
            [Interval(1, 4), Interval(4, 6), Interval(6, 9)],
            [Timestamp(2019, 1, 1), Timestamp(
                2019, 2, 1), Timestamp(2019, 3, 1)],
