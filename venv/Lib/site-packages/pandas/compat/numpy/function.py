...
def validate_argmin_with_skipna(
        skipna: bool | ndarray | None, args, kwargs) -> bool:
    """
...
def validate_argsort_with_ascending(
        ascending: bool | int | None, args, kwargs) -> bool:
    """
...
def validate_take_with_convert(
        convert: ndarray | bool | None, args, kwargs) -> bool:
    """
    If this function is called via the 'numpy' library, the third parameter in
