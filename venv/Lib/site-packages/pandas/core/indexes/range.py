...
class RangeIndex(Index):
    ...
    @classmethod
    def from_range(cls, data: range, name=None,
                   dtype: Dtype | None = None) -> Self:
        """
            ...
            if sort in (None, True) or (
                ...
                if step_o == step_s:
                    ...
                    if (
                        ...
                        return type(self)(start_r, end_r +
                                          step_s / 2, step_s / 2)
    ...
    def _difference(self, other, sort=None):
        ...
        # overlap.step will always be a multiple of self.step (see
        # _intersection)
    ...
    def _cmp_method(self, other, op):
        if isinstance(other, RangeIndex) and self._range == other._range:
            # Both are immutable so if ._range attr. are equal, shortcut is
            # possible
