...
@inherit_names(["is_non_overlapping_monotonic", "closed"],
               IntervalArray, cache=True)
class IntervalIndex(ExtensionIndex):
    ...
    def _multiindex(self) -> MultiIndex:
        return MultiIndex.from_arrays(
            [self.left, self.right], names=["left", "right"])
    ...
    def memory_usage(self, deep: bool = False) -> int:
        ...
        return self.left.memory_usage(
            deep=deep) + self.right.memory_usage(deep=deep)
    ...
    def get_indexer_non_unique(
        ...
        if not self._should_compare(
            ...
            if self.left.is_unique and self.right.is_unique:
                # fastpath available even if we don't have
