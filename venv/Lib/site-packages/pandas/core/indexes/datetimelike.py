...
class DatetimeIndexOpsMixin(NDArrayBackedExtensionIndex, ABC):
    ...
    def freqstr(self) -> str:
        ...
        if self._data.freqstr is not None and isinstance(
            ...
            freq = freq_to_period_freqstr(
                self._data.freq.n, self._data.freq.name)
            return freq
        else:
    ...
    def _format_attrs(self):
        ...
        for attrib in self._attributes:
            # iterating over _attributes prevents us from doing this for
            # PeriodIndex
            if attrib == "freq":
                freq = self.freqstr
                if freq is not None:
