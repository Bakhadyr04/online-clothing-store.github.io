...
class Resampler(BaseGroupBy, PandasObject):
    ...
    def _gotitem(self, key, ndim: int, subset=None):
        ...
        if subset is None:
            ...
            if key is not None:
                ...
                # reached via Apply.agg_dict_like with selection=None and
                # ndim=1
    ...
    def _groupby_and_aggregate(self, how, *args, **kwargs):
        ...
        try:
            ...
            if "Must produce aggregated value" in str(err):
                ...
                # see test_apply_without_aggregation,
    ...
    def sum(
        ...
        **kwargs,
        ...
        return self._downsample(
            "sum", numeric_only=numeric_only, min_count=min_count)
    ...
    def prod(
        ...
        **kwargs,
        ...
        return self._downsample(
            "prod", numeric_only=numeric_only, min_count=min_count)
    ...
    def min(
        ...
        **kwargs,
        ...
        return self._downsample(
            "min", numeric_only=numeric_only, min_count=min_count)
    ...
    def max(
        ...
        **kwargs,
        ...
        return self._downsample(
            "max", numeric_only=numeric_only, min_count=min_count)
...
class _GroupByMixin(PandasObject, SelectionMixin):
    ...
    def _gotitem(self, key, ndim, subset=None):
        ...
        try:
            if isinstance(
                    key, list) and self.key not in key and self.key is not None:
                key.append(self.key)
    ...
    def _set_grouper(
        ...
        if isinstance(ax.dtype, ArrowDtype) and ax.dtype.kind in "Mm":
            ...
            ax = Index(
                cast(
                    ArrowExtensionArray,
                    ax.array)._maybe_convert_datelike_array()
            )
...
def _take_new_index(
    ...
    if isinstance(obj, ABCSeries):
        ...
        # error: Incompatible return value type (got "Series", expected
        # "NDFrameT")
        ...
        # "NDFrameT")
        return obj._constructor_from_mgr(
            new_mgr, axes=new_mgr.axes)  # type: ignore[return-value]
    else:
...
def _get_timestamp_range_edges(
    ...
    if isinstance(freq, Tick):
        index_tz = first.tz
        if isinstance(origin, Timestamp) and (
                origin.tz is None) != (index_tz is None):
            raise ValueError(
