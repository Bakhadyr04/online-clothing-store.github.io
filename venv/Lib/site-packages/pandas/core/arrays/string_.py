    ...
    def __from_arrow__(
        ...
        if self.storage == "pyarrow":
            ...
            for arr in chunks:
                ...
                # overflow for large string data when concatenating the pyarrow
                # arrays
...
class StringArray(BaseStringArray, NumpyExtensionArray):  # type: ignore[misc]
    ...
    def __init__(self, values, copy: bool = False) -> None:
        ...
        if not isinstance(values, type(self)):
            self._validate()
        NDArrayBacked.__init__(
            self, self._ndarray, StringDtype(
                storage="python"))
    ...
    def _from_sequence(cls, scalars, *, dtype: Dtype |
        ...
        if isinstance(scalars, BaseMaskedArray):
            ...
            # convert non-na-likes to str, and nan-likes to
        ...
        NDArrayBacked.__init__(
            new_string_array, result, StringDtype(
                storage="python"))
