...
class BaseMaskedArray(OpsMixin, ExtensionArray):
    ...
    @classmethod
    def _simple_new(cls, values: np.ndarray,
                    mask: npt.NDArray[np.bool_]) -> Self:
    ...
    def _validate_setitem_value(self, value):
        ...
        if kind == "b":
            ...
            if lib.is_integer(value) or (
                    lib.is_float(value) and value.is_integer()):
                return value
    ...
    def to_numpy(
        ...
        if hasna:
            ...
            # don't pass copy to astype -> always need a copy since we are
            # mutating
    ...
    def astype(self, dtype: AstypeArg, copy: bool = True) -> ArrayLike:
        ...
        # to_numpy will also raise, but we get somewhat nicer exception
        # messages here
    ...
    def isin(self, values: ArrayLike) -> BooleanArray:
        ...
        if self._hasna:
            ...
            # see https://github.com/pandas-dev/pandas/pull/38379 for some
            # discussion
    ...
    def factorize(
        ...
        # Use a sentinel for na; recode and add NA to uniques if necessary
        # below
    ...
    def _wrap_min_count_reduction_result(
        ...
        if min_count == 0 and isinstance(result, np.ndarray):
            return self._maybe_mask_result(
                result, np.zeros(result.shape, dtype=bool))
    ...
    def mean(self, *, skipna: bool = True, axis: AxisInt | None = 0, **kwargs):
        ...
        return self._wrap_reduction_result(
            "mean", result, skipna=skipna, axis=axis)
    ...
    def var(
        ...
        return self._wrap_reduction_result(
            "var", result, skipna=skipna, axis=axis)
    ...
    def std(
        ...
        return self._wrap_reduction_result(
            "std", result, skipna=skipna, axis=axis)
    ...
    def min(self, *, skipna: bool = True, axis: AxisInt | None = 0, **kwargs):
        ...
        return self._wrap_reduction_result(
            "min", result, skipna=skipna, axis=axis)
    ...
    def max(self, *, skipna: bool = True, axis: AxisInt | None = 0, **kwargs):
        ...
        return self._wrap_reduction_result(
            "max", result, skipna=skipna, axis=axis)
