...
class PeriodArray(
        dtl.DatelikeOps, libperiod.PeriodMixin):  # type: ignore[misc]
    """
    ...
    def _unbox_scalar(  # type: ignore[override]
        ...
        if value is NaT:
            # error: Item "Period" of "Union[Period, NaTType]" has no attribute
            # "value"
    ...
    def _check_compatible_with(self, other: Period |
                               NaTType | PeriodArray) -> None:
        if other is NaT:
            return
    ...
    def asfreq(self, freq=None, how: str = "E") -> Self:
        ...
        """
        how = libperiod.validate_end_alias(how)
        if isinstance(freq, BaseOffset) and hasattr(
