...
class ExtensionArray:
    ...
    * _from_sequence_of_strings
    ...
    def repeat(self, repeats: int |
               Sequence[int], axis: AxisInt | None = None) -> Self:
    ...
    def ravel(self, order: Literal["C", "F", "A",
              "K"] | None = "C") -> ExtensionArray:
        """
    ...
    def _concat_same_type(cls, to_concat: Sequence[Self]) -> Self:
        ...
        # Note: this strict behaviour is only guaranteed starting with pandas
        # 1.1
        raise AbstractMethodError(cls)
    ...
    def __array_ufunc__(self, ufunc: np.ufunc, method: str, *inputs, **kwargs):
        ...
        return arraylike.default_array_ufunc(
            self, ufunc, method, *inputs, **kwargs)
            ...
            def _maybe_convert(arr):
                if coerce_to_dtype:
                    ...
                    if not isinstance(res, type(self)):
                        # exception raised in _from_sequence; ensure we have
                        # ndarray
                        res = np.asarray(arr)
                else:
