    ...
    def apply_list_or_dict_like(self) -> DataFrame | Series:
        ...
        if self.axis == 1 and isinstance(self.obj, ABCDataFrame):
            return self.obj.T.apply(
                self.func, 0, args=self.args, **self.kwargs).T
...
class FrameApply(NDFrameApply):
    ...
    def apply(self) -> DataFrame | Series:
        ...
        # raw
            ...
            return self.apply_raw(engine=self.engine,
    ...
    def wrap_results(self, results: ResType,
                     res_index: Index) -> DataFrame | Series:
        from pandas import Series
...
class FrameRowApply(FrameApply):
    ...
    def apply_with_numba(self) -> dict[int, Any]:
        ...
        # Our isinstance checks in the df constructor don't pass for numbas
        # typed dict
    ...
    def wrap_results_for_axis(
        ...
        if self.result_type == "reduce":
            ...
            # test_apply_dict GH#8735, test_apply_reduce_to_dict GH#25196
            # #37544
            res = self.obj._constructor_sliced(results)
            res.index = res_index
            return res
...
class FrameColumnApply(FrameApply):
    ...
    def infer_to_same_shape(self, results: ResType,
                            res_index: Index) -> DataFrame:
...
def relabel_result(
    ...
    for col, fun in func.items():
        ...
        # reorder so that aggregated values map to their functions regarding
        # the order.
...
def reconstruct_and_relabel_result(
        result, func, **kwargs) -> DataFrame | Series:
...
def include_axis(op_name: Literal["agg", "apply"],
                 colg: Series | DataFrame) -> bool:
