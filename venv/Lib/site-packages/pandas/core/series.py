...
class Series(base.IndexOpsMixin, NDFrame):  # type: ignore[misc]
    ...
    # but before Index and ExtensionArray.  Should NOT be overridden by
    # subclasses.
    __pandas_priority__ = 3000

    # Override cache_readonly bc Series is mutable
    # error: Incompatible types in assignment (expression has type "property",
    # base class "IndexOpsMixin" defined the type as
    # "Callable[[IndexOpsMixin], bool]")
    ...
    def __init__(
        ...
        if isinstance(
                data, SingleBlockManager) and using_copy_on_write() and not copy:
            data = data.copy(deep=False)
    ...
    def _constructor_expanddim_from_mgr(self, mgr, axes):
        ...
        if type(self) is Series:
            ...
            # but this check is slightly faster, benefiting the most-common
            # case.
            return df
    ...
    def __column_consortium_standard__(
            self, *, api_version: str | None = None) -> Any:
        """
    ...
    def __getitem__(self, key):
        ...
        if is_hashable(key) and not isinstance(key, slice):
            ...
            try:
                # For labels that don't resolve as scalars like tuples and
                # frozensets
    ...
    def _get_with(self, key):
        ...
        if not isinstance(
                key, (list, np.ndarray, ExtensionArray, Series, Index)):
            key = list(key)
    ...
    def repeat(self, repeats: int |
               Sequence[int], axis: None = None) -> Series:
        """
    ...
    # dict[Any, Any]]", argument has type "type[MutableMappingT] |
    # MutableMappingT")
    @deprecate_nonkeyword_arguments(
    ...
    def idxmin(self, axis: Axis = 0, skipna: bool = True,
    ...
    def idxmax(self, axis: Axis = 0, skipna: bool = True,
               *args, **kwargs) -> Hashable:
        """
    ...
    def aggregate(self, func=None, axis: Axis = 0, *args, **kwargs):
        ...
        # if func is None, will switch to user-provided "named aggregation"
        # kwargs
        if func is None:
    ...
    def case_when(
        ...
        caselist: list[
            tuple[
                ArrayLike | Callable[[Series],
                                     Series | np.ndarray | Sequence[bool]],
        ...
        common_dtypes = [
            infer_dtype_from(arg)[0] for arg in [
    ...
    def to_period(self, freq: str | None = None,
                  copy: bool | None = None) -> Series:
        """
    ...
    def _binop(self, other: Series, func, level=None,
               fill_value=None) -> Series:
        """
    ...
    def _flex_method(self, other, op, *, level=None,
                     fill_value=None, axis: Axis = 0):
        if axis is not None:
            self._get_axis_number(axis)
    ...
    def radd(self, other, level=None, fill_value=None,
             axis: Axis = 0) -> Series:
        return self._flex_method(
    ...
    def sub(self, other, level=None, fill_value=None,
            axis: Axis = 0) -> Series:
        return self._flex_method(
    ...
    def rmul(self, other, level=None, fill_value=None,
             axis: Axis = 0) -> Series:
        return self._flex_method(
    ...
    def truediv(self, other, level=None, fill_value=None,
                axis: Axis = 0) -> Series:
        return self._flex_method(
    ...
    def rtruediv(self, other, level=None, fill_value=None,
                 axis: Axis = 0) -> Series:
        return self._flex_method(
    ...
    def rfloordiv(self, other, level=None, fill_value=None,
                  axis: Axis = 0) -> Series:
        return self._flex_method(
    ...
    def mod(self, other, level=None, fill_value=None,
            axis: Axis = 0) -> Series:
        return self._flex_method(
    ...
    def rmod(self, other, level=None, fill_value=None,
             axis: Axis = 0) -> Series:
        return self._flex_method(
    ...
    def pow(self, other, level=None, fill_value=None,
            axis: Axis = 0) -> Series:
        return self._flex_method(
    ...
    def divmod(self, other, level=None, fill_value=None,
               axis: Axis = 0) -> Series:
        return self._flex_method(
    ...
    def rdivmod(self, other, level=None, fill_value=None,
                axis: Axis = 0) -> Series:
        return self._flex_method(
    ...
    def _reduce(
        self,
        op,
        # error: Variable "pandas.core.series.Series.str" is not valid as a
        # type
    ...
    def sum(
        ...
        **kwargs,
        ...
        return NDFrame.sum(self, axis, skipna, numeric_only,
                           min_count, **kwargs)
    ...
    def prod(
        ...
        **kwargs,
        ...
        return NDFrame.prod(self, axis, skipna,
                            numeric_only, min_count, **kwargs)
