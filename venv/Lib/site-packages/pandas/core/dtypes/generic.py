...
def create_pandas_abc_type(name, attr, comp):
    ...
    dct = {"__instancecheck__": _instancecheck,
           "__subclasscheck__": _subclasscheck}
...
ABCCategoricalIndex = cast(
    ...
    create_pandas_abc_type("ABCCategoricalIndex",
...
ABCDataFrame = cast(
    "Type[DataFrame]", create_pandas_abc_type(
        "ABCDataFrame", "_typ", ("dataframe",))
)
...
ABCExtensionArray = cast(
    ...
    create_pandas_abc_type(
        "ABCExtensionArray",
        "_typ",
        # Note: IntervalArray and SparseArray are included bc they have
        # _typ="extension"
        {"extension", "categorical", "periodarray",
            "datetimearray", "timedeltaarray"},
    ),
)
ABCNumpyExtensionArray = cast(
    "Type[NumpyExtensionArray]",
    create_pandas_abc_type("ABCNumpyExtensionArray",
                           "_typ", ("npy_extension",)),
)
