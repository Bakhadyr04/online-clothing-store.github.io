...
# handle unions
@overload
def isna(obj: NDFrameT | ArrayLike | Index |
         list) -> NDFrameT | npt.NDArray[np.bool_]:
    ...
...
def _isna_string_dtype(values: np.ndarray,
                       inf_as_na: bool) -> npt.NDArray[np.bool_]:
...
# handle unions
@overload
def notna(obj: NDFrameT | ArrayLike | Index |
          list) -> NDFrameT | npt.NDArray[np.bool_]:
    ...
