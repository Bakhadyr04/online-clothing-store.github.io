...
class Term(ops.Term):
    ...
    def __init__(self, name, env: PyTablesScope,
                 side=None, encoding=None) -> None:
        super().__init__(name, env, side=side, encoding=encoding)

    def _resolve_name(self):
        # must be a queryables
        if self.side == "left":
            # Note: The behavior of __new__ ensures that self.name is a str
            # here
...
class BinOp(ops.BinOp):
    ...
    def __init__(self, op: str, lhs, rhs,
                 queryables: dict[str, Any], encoding) -> None:
