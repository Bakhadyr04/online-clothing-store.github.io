...
class PandasColumn(Column):
    ...
    def offset(self) -> int:
        ...
        """
        # TODO: chunks are implemented now, probably this should return
        # something
        return 0
    ...
    def _dtype_from_pandasdtype(
            self, dtype) -> tuple[DtypeKind, int, str, str]:
        """
    ...
    def describe_null(self):
        ...
        if isinstance(self._col.dtype, ArrowDtype):
            ...
            if self._col.array._pa_array.chunks[0].buffers(
            )[0] is None:  # type: ignore[attr-defined]
    ...
    def _get_data_buffer(
        ...
        if self.dtype[0] in (
            ...
            # TODO: this for-loop is slow; can be implemented in Cython/C/C++
            # later
            for obj in buf:
