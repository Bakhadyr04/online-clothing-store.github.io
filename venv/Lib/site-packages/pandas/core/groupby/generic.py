...
class SeriesGroupBy(GroupBy[Series]):
    ...
    def aggregate(self, func=None, *args, engine=None,
    ...
    def _aggregate_named(self, func, *args, **kwargs):
        ...
        for name, group in self._grouper.get_iterator(
            ...
            # needed for
            # pandas/tests/groupby/test_groupby.py::test_basic_aggregations
    ...
    def transform(self, func, *args, engine=None,
                  engine_kwargs=None, **kwargs):
...
class DataFrameGroupBy(GroupBy[DataFrame]):
    ...
    def aggregate(self, func=None, *args, engine=None,
        ...
        if result is None:
            ...
            if self._grouper.nkeys > 1:
                # test_groupby_as_index_series_scalar gets here with 'not
                # self.as_index'
                return self._python_agg_general(func, *args, **kwargs)
            elif args or kwargs:
    ...
    def _choose_path(self, fast_path: Callable,
                     slow_path: Callable, group: DataFrame):
        path = slow_path
        res = slow_path(group)
