...
def extract_result(res):
    ...
    if hasattr(res, "_values"):
        ...
        if res.ndim == 1 and len(res) == 1:
            # see test_agg_lambda_with_timezone,
            # test_resampler_grouper.py::test_apply
            res = res[0]
    return res
    ...
    def _call_cython_op(
        ...
        **kwargs,
        ...
        if self.kind == "aggregate" and self.how not in ["idxmin", "idxmax"]:
            ...
            # see GH#40767. For idxmin/idxmax is handled specially via
            # post-processing
...
class BaseGrouper:
    ...
    def result_ilocs(self) -> npt.NDArray[np.intp]:
        ...
        if self.has_dropped_na:
            ...
            # Count how many gaps are caused by previous null values for each
            # position
    ...
    @cache_readonly
    def group_info(
            self) -> tuple[npt.NDArray[np.intp], npt.NDArray[np.intp], int]:
    ...
    def _get_compressed_codes(
        ...
        if len(self.groupings) > 1:
            ...
            # FIXME: compress_group_index's second return value is int64, not
            # intp
...
class BinGrouper(BaseGrouper):
    ...
    def reconstructed_codes(self) -> list[np.ndarray]:
        # get unique result indices, and prepend 0 as groupby starts from the
        # first
