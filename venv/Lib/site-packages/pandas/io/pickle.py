...
def read_pickle(
    ...
    with get_handle(
        ...
        try:
            # TypeError for Cython complaints about object.__new__ vs
            # Tick.__new__
            try:
                with warnings.catch_warnings(record=True):
                    # We want to silence any warnings about, e.g. moved
                    # modules.
            ...
            # e.g. can occur for files written in py27; see GH#28645 and
            # GH#31988
