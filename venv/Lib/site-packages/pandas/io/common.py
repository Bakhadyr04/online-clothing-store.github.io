...
@overload
def stringify_path(filepath_or_buffer: FilePath,
                   convert_file_like: bool = ...) -> str:
    ...
...
def _get_filepath_or_buffer(
    ...
    if compression_method and hasattr(
            filepath_or_buffer, "write") and "b" not in mode:
        warnings.warn(
    ...
    if is_fsspec_url(filepath_or_buffer):
        ...
        # GH 34626 Reads from Public Buckets without Credentials needs
        # anon=True
...
@doc(compression_options=_shared_docs["compression_options"] %
     "filepath_or_buffer")
...
class _BytesIOWrapper:
    ...
    def __init__(self, buffer: StringIO | TextIOBase,
        ...
        # overflow to the front of the bytestring the next time reading is
        # performed
        self.overflow = b""
    ...
    def read(self, n: int | None = -1) -> bytes:
        ...
        # When n=-1/n greater than remaining bytes: Read entire file/rest of
        # file
