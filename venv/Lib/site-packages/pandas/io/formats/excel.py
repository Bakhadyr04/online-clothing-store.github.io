    ...
    def __init__(
        ...
        **kwargs,
        ...
        if css_styles and css_converter:
            # Use dict to get only one (case-insensitive) declaration per
            # property
            declaration_dict = {
...
class CSSToExcelConverter:
    ...
    def build_xlstyle(
            self, props: Mapping[str, str]) -> dict[str, dict[str, str]]:
        out = {
    ...
    def _border_style(self, style: str | None, width: str |
                      None, color: str | None):
    ...
    def build_fill(self, props: Mapping[str, str]):
        ...
        if fill_color not in (None, "transparent", "none"):
            return {"fgColor": self.color_to_excel(
                fill_color), "patternType": "solid"}

    def build_number_format(
            self, props: Mapping[str, str]) -> dict[str, str | None]:
