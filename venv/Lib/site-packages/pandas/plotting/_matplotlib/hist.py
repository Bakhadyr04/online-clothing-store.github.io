...
class HistPlot(LinePlot):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        MPLPlot.__init__(
            self,
            data,
            **kwargs)  # pylint: disable=non-parent-init-called
    ...
    def _make_plot(self, fig: Figure) -> None:
        ...
        # type "object"; expected "DataFrame | dict[Hashable, Series |
        # DataFrame]"
        for i, (label, y) in enumerate(
                self._iter_data(data=data)):  # type: ignore[arg-type]
            ax = self._get_ax(i)
            ...
            # when by is applied, show title for subplots to know which group
            # it is
            if self.by is not None:
    ...
    def _get_column_weights(weights, i: int, y):
        ...
        # provide 1D array, we assume the same weights is used for all
        # iterations
...
def hist_series(
    ...
    **kwds,
    ...
    if by is None:
        ...
        if figsize is not None and tuple(
