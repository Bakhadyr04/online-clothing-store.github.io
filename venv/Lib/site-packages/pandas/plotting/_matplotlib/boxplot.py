...
def _set_ticklabels(
        ax: Axes, labels: list[str], is_vertical: bool, **kwargs) -> None:
    ...
    def _make_plot(self, fig: Figure) -> None:
        if self.subplots:
            ...
            for i, (label, y) in enumerate(
                ...
                # just like df.boxplot, and need to apply T on y to provide
                # right input
                if self.by is not None:
                    y = y.T
                    ...
                    # error: "Index" has no attribute "levels"; maybe
                    # "nlevels"?
...
def boxplot(
    ...
    **kwds,
    ...
    def plot_group(keys, values, ax: Axes, **kwds):
        ...
        values = [
            np.asarray(
                remove_na_arraylike(v),
                dtype=object) for v in values]
