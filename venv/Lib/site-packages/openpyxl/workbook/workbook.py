...
class Workbook:
    ...
    def worksheets(self):
        ...
        """
        return [s for s in self._sheets if isinstance(
            s, (Worksheet, ReadOnlyWorksheet, WriteOnlyWorksheet))]
    ...
    def create_named_range(self, name, worksheet=None, value=None, scope=None):
        ...
        if worksheet is not None:
            defn.value = "{0}!{1}".format(
                quote_sheetname(worksheet.title), value)
        else:
            defn.value = value
