...
def get_active_sheet(wb):
    ...
    """
    visible_sheets = [idx for idx, sheet in enumerate(
        wb._sheets) if sheet.sheet_state == "visible"]
...
class WorkbookWriter:
    ...
    def write_root_rels(self):
        ...
        rels.append(rel)
        rel = Relationship(
            Type=f"{PKG_REL_NS}/metadata/core-properties",
            Target=ARC_CORE)
        rels.append(rel)
