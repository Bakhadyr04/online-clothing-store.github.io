...
class PlotArea(Serialisable):
    ...
    scatterChart = MultiSequencePart(
        expected_type=ScatterChart, store="_charts")
    ...
    doughnutChart = MultiSequencePart(
        expected_type=DoughnutChart, store="_charts")
    ...
    ofPieChart = MultiSequencePart(
        expected_type=ProjectedPieChart,
        store="_charts")
    surfaceChart = MultiSequencePart(
        expected_type=SurfaceChart, store="_charts")
    surface3DChart = MultiSequencePart(
        expected_type=SurfaceChart3D, store="_charts")
