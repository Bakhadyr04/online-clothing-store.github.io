...
# indices 64 and 65 are reserved for the system foreground and background
...
class Color(Serialisable):
    ...
    def __init__(self, rgb=BLACK, indexed=None, auto=None,
                 theme=None, tint=0.0, index=None, type='rgb'):
