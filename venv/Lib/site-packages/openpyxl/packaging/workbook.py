...
class WorkbookPackage(Serialisable):
    ...
    workbookProtection = Typed(
        expected_type=WorkbookProtection,
        allow_none=True)
    ...
    fileRecoveryPr = Typed(
        expected_type=FileRecoveryProperties,
        allow_none=True)
    webPublishObjects = Typed(
        expected_type=WebPublishObjectList,
        allow_none=True)
