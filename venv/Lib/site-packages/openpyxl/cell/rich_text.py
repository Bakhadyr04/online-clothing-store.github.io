...
# t = CellRichText(node) # where node is an Element() from either lxml or
# xml.etree (has a 'tag' element)
...
class CellRichText(list):
    ...
    def __iadd__(self, arg):
        # copy used here to create new TextBlock() so we don't modify the right
        # hand side in _opt()
