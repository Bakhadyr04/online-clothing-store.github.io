...
class relativedelta(object):
    ...
    def __init__(self,
        ...
        if dt1 and dt2:
            ...
            if not (isinstance(dt1, datetime.date)
                    and isinstance(dt2, datetime.date)):
            ...
            if yday:
                ydayidx = [
                    31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 366
                ]
        ...
        if isinstance(other, relativedelta):
            return self.__class__(
                ...
                weekday=(other.weekday
                         if other.weekday is not None else self.weekday),
    ...
    def __sub__(self, other):
        ...
        return self.__class__(
            ...
            weekday=(self.weekday
                     if self.weekday is not None else other.weekday),
            ...
            microsecond=(self.microsecond if self.microsecond is not None else
                         other.microsecond))
    ...
    def __bool__(self):
        return not (not self.years and not self.months and not self.days and
                    not self.hours and not self.minutes and not self.seconds
                    and not self.microseconds and not self.leapdays
                    and self.year is None and self.month is None
                    and self.day is None and self.weekday is None
                    and self.hour is None and self.minute is None
                    and self.second is None and self.microsecond is None)
    ...
    def __eq__(self, other):
        ...
        return (self.years == other.years and self.months == other.months
                ...
                and self.leapdays == other.leapdays and self.year == other.year
    ...
    def __repr__(self):
        l = []
        for attr in [
                "years", "months", "days", "leapdays", "hours", "minutes",
