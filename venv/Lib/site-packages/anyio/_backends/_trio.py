...
class CancelScope(BaseCancelScope):
    ...
    def __new__(cls,
                original: trio.CancelScope | None = None,
...
class ConnectedUNIXDatagramSocket(_TrioSocketMixin[str],
...
class Lock(BaseLock):
    ...
    def statistics(self) -> LockStatistics:
        orig_statistics = self.__original.statistics()
        owner = TrioTaskInfo(
            orig_statistics.owner) if orig_statistics.owner else None
        return LockStatistics(orig_statistics.locked, owner,
...
_capacity_limiter_wrapper: trio.lowlevel.RunVar = RunVar(
    "_capacity_limiter_wrapper")
...
class TestRunner(abc.TestRunner):
    ...
    def run_asyncgen_fixture(
        ...
        fixturevalue: T_Retval = self._call_in_runner_task(
            asyncgen.asend, None)
...
class TrioBackend(AsyncBackend):
    ...
    def create_cancel_scope(cls,
                            *,
                            ...
                            shield: bool = False) -> abc.CancelScope:
    ...
    async def open_process(
        ...
        **kwargs: Any,
        ...
        stdin_stream = SendStreamWrapper(
            process.stdin) if process.stdin else None
        stdout_stream = ReceiveStreamWrapper(
            process.stdout) if process.stdout else None
        stderr_stream = ReceiveStreamWrapper(
    ...
    async def create_unix_datagram_socket(
            ...
            remote_path: None) -> abc.UNIXDatagramSocket:
        ...
    ...
    async def create_unix_datagram_socket(
            cls, raw_socket: socket.socket,
            remote_path: str | bytes) -> abc.ConnectedUNIXDatagramSocket:
        ...
    ...
    async def getaddrinfo(
        ...
        *,
        ...
        return await trio.socket.getaddrinfo(host, port, family, type, proto,
                                             flags)
    ...
    async def wait_readable(cls, obj: HasFileno | int) -> None:
        try:
            ...
            raise ClosedResourceError().with_traceback(
