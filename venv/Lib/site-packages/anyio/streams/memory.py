...
class MemoryObjectItemReceiver(Generic[T_Item]):
    ...
    def __repr__(self) -> str:
        ...
        # AttributeError: 'MemoryObjectItemReceiver' object has no attribute
        # 'item'
...
class MemoryObjectStreamState(Generic[T_Item]):
    ...
    waiting_receivers: OrderedDict[Event,
                                   MemoryObjectItemReceiver[T_Item]] = field(
                                       init=False, default_factory=OrderedDict)
    waiting_senders: OrderedDict[Event,
                                 T_Item] = field(init=False,
...
class MemoryObjectSendStream(Generic[T_contra], ObjectSendStream[T_contra]):
    ...
    def send_nowait(self, item: T_contra) -> None:
        ...
        while self._state.waiting_receivers:
            receive_event, receiver = self._state.waiting_receivers.popitem(
                last=False)
