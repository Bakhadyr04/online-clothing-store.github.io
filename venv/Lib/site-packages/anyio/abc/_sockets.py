...
class _SocketProvider(TypedAttributeProvider):
    ...
    def extra_attributes(self) -> Mapping[Any, Callable[[], Any]]:
        ...
        attributes: dict[Any, Callable[[], Any]] = {
            ...
            lambda: self._raw_socket.family,
            SocketAttribute.local_address:
            lambda: convert(self._raw_socket.getsockname()),
            SocketAttribute.raw_socket:
            lambda: self._raw_socket,
        }
        try:
            peername: tuple[str, int] | None = convert(
        ...
        if self._raw_socket.family in (AddressFamily.AF_INET,
...
class UNIXDatagramSocket(UnreliableObjectStream[UNIXDatagramPacketType],
                         _SocketProvider):
    """
