...
def _set_requirement_extras(req: Requirement,
    ...
    extras: str = "[{}]".format(
        ",".join(sorted(new_extras)) if new_extras else "")
        ...
        req = install_req_from_line(
            ...
            hash_options=(
                parsed_req.options.get(
                    "hashes", {}) if parsed_req.options else {}
            ),
            constraint=parsed_req.constraint,
    ...
    return InstallRequirement(
        req=(
            _set_requirement_extras(
                ireq.req, set()) if ireq.req is not None else None
        ),
        comes_from=ireq,
        editable=ireq.editable,
        link=ireq.link,
