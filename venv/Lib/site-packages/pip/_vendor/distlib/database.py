...
class Distribution(object):
    ...
    def _get_requirements(self, req_attr):
        ...
        logger.debug(
            '%s: got requirements %r from metadata: %r',
            self.name,
            req_attr,
            reqts)
        return set(md.get_requirements(
            reqts, extras=self.extras, env=self.context))
    ...
    def __eq__(self, other):
        ...
        if type(other) is not type(self):
            ...
            result = (self.name == other.name and self.version ==
                      other.version and self.source_url == other.source_url)
        return result
    ...
    def topological_sort(self):
        ...
        while True:
            ...
            logger.debug(
                'Moving to result: %s', [
                    '%s (%s)' %
                    (d.name, d.version) for d in to_remove])
