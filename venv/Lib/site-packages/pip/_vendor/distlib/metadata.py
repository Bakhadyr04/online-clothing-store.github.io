...
_566_FIELDS = _426_FIELDS + \
    ('Description-Content-Type', 'Requires', 'Provides', 'Obsoletes')
...
def _best_version(fields):
    ...
    keys = [
        key for key,
        value in fields.items() if value not in (
            [],
            'UNKNOWN',
            None)]
    possible_versions = [
...
class Metadata(object):
    ...
    def __getattribute__(self, key):
        ...
        if key in mapped:
            ...
            if self._legacy:
                ...
                if key not in ('commands', 'exports', 'modules',
    ...
    def _from_legacy(self):
        ...
        for k in ('name', 'version', 'license',
                  'summary', 'description', 'classifier'):
            if k in lmd:
                if k == 'classifier':
                    nk = 'classifiers'
                else:
