...
class ISO8601Highlighter(RegexHighlighter):
    ...
    highlights = [
        ...
        # Time zone designator (e.g., Z, +07 or +07:00). The colons and the
        # minutes are optional
        r"^(?P<timezone>(Z|[+-](?:2[0-3]|[01][0-9])(?::?(?:[0-5][0-9]))?))$",
        # Hours, minutes, and seconds with time zone designator (e.g., 17:21:59+07:00).
        # All the colons are optional. The minutes in the time zone designator
        # are also optional
        ...
        # There is no limit on the number of digits for the fractional seconds.
        # This is the XML Schema 'time' type
