...
class Syntax(JupyterMixin):
    ...
    def highlight(
        ...
        if lexer is None:
            ...
            if line_range:
                ...
                # This speeds up further operations as there are less spans to
                # process
    ...
    def _get_number_styles(
            self, console: Console) -> Tuple[Style, Style, Style]:
    ...
    def _apply_stylized_ranges(self, text: Text) -> None:
        ...
        newlines_offsets = [
            ...
            0,
            # N.B. using "\n" here is much faster than using metacharacters
            # such as "^" or "\Z":
            *[
                match.start() + 1
...
def _get_code_index_for_syntax_position(
    ...
    line_length = newlines_offsets[line_index +
                                   1] - newlines_offsets[line_index] - 1
