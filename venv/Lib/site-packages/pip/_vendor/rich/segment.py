...
class Segment(NamedTuple):
    ...
    @classmethod
    @lru_cache(1024 * 16)
    def _split_cells(cls, segment: "Segment",
                     cut: int) -> Tuple["Segment", "Segment"]:
    ...
    @classmethod
    def split_lines(
            cls, segments: Iterable["Segment"]) -> Iterable[List["Segment"]]:
    ...
    def get_line_length(cls, line: List["Segment"]) -> int:
        ...
        """
        _cell_len = cell_len
        return sum(_cell_len(text)
                   for text, style, control in line if not control)
    ...
    def get_shape(cls, lines: List[List["Segment"]]) -> Tuple[int, int]:
        ...
        max_width = max(get_line_length(line)
    ...
    def set_shape(
        ...
        blank = (
            [cls(" " * width + "\n", style)
             ] if new_lines else [cls(" " * width, style)]
        )
    ...
    @classmethod
    def strip_styles(
            cls, segments: Iterable["Segment"]) -> Iterable["Segment"]:
