...
def install(
    *,
    ...
    def ipy_excepthook_closure(ip: Any) -> None:  # pragma: no cover
        ...
        # this is also what the ipython docs recommends to modify when
        # subclassing InteractiveShell
...
class Traceback:
    ...
    def _guess_lexer(cls, filename: str, code: str) -> str:
        ...
        if not ext:
            ...
            # If it fails, the only downside is that the code is highlighted
            # strangely
            ...
            if first_line.startswith("#!") and "python" in first_line.lower():
                return "python"
        try:
            return cls.LEXERS.get(ext) or guess_lexer_for_filename(
                filename, code).name
