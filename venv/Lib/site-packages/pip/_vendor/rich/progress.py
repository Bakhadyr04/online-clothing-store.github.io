...
class _TrackThread(Thread):
    ...
    def __init__(self, progress: "Progress",
                 task_id: "TaskID", update_period: float):
...
def track(
    ...
    columns: List["ProgressColumn"] = (
        [TextColumn(
            "[progress.description]{task.description}")] if description else []
    )
    columns.extend(
        (
            BarColumn(
...
class TaskProgressColumn(TextColumn):
    ...
    def render_speed(cls, speed: Optional[float]) -> Text:
        ...
        return Text(f"{data_speed:.1f}{suffix} it/s",
...
class TotalFileSizeColumn(ProgressColumn):
    ...
    def render(self, task: "Task") -> Text:
        """Show data completed."""
        data_size = filesize.decimal(
            int(task.total)) if task.total is not None else ""
