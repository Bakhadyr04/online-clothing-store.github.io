...
class Text(JupyterMixin):
    ...
    def on(self, meta: Optional[Dict[str, Any]]
           = None, **handlers: Any) -> "Text":
    ...
    def highlight_regex(
        ...
        *,
        ...
        for match in re.finditer(re_highlight, plain):
            ...
            if style:
                start, end = get_span()
                match_style = style(plain[start:end]) if callable(
                    style) else style
    ...
    def align(self, align: AlignMethod, width: int,
              character: str = " ") -> None:
    ...
    def detect_indentation(self) -> int:
        ...
        try:
            indentation = (
                reduce(
                    gcd, [
                        indent for indent in _indentations if not indent %
                        2]) or 1
            )
        except TypeError:
            indentation = 1
