...
class BmpImageFile(ImageFile.ImageFile):
    ...
    def _bitmap(self, header=0, offset=0):
        ...
        # v3, OS/2 v2, v4, v5
            ...
            self.info["dpi"] = tuple(
                x / 39.3701 for x in file_info["pixels_per_meter"])
            ...
            raise OSError(
                f"Unsupported BMP header type ({file_info['header_size']})")
        ...
        if file_info["compression"] == self.BITFIELDS:
            ...
            raise OSError(
                f"Unsupported BMP compression ({file_info['compression']})")
        ...
        if self.mode == "P":  # Paletted for 1, 4 and 8 bit images
            ...
            if not (0 < file_info["colors"] <= 65536):
                raise OSError(
                    f"Unsupported BMP Palette size ({file_info['colors']})")
            else:
