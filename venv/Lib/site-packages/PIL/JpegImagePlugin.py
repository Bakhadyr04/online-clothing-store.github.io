...
class JpegImageFile(ImageFile.ImageFile):
    ...
    def load_read(self, read_bytes):
        ...
        if not s and ImageFile.LOAD_TRUNCATED_IMAGES and not hasattr(
                self, "_ended"):
            # Premature EOF.
...
def _getmp(self):
    ...
    try:
        ...
        for entrynum in range(0, quant):
            ...
            mpentryattr["MPType"] = mptypemap.get(
                mpentryattr["MPType"], "Unknown")
...
def convert_dict_qtables(qtables):
    deprecate(
        ...
        10,
        action="Conversion is no longer needed")
    return qtables
