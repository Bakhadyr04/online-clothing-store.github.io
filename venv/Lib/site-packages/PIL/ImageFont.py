...
class FreeTypeFont:
    ...
    def __init__(self, font=None, size=10, index=0,
        ...
        if is_path(font):
            if sys.platform == "win32":
                font_bytes_path = font if isinstance(
                    font, bytes) else font.encode()
                try:
    ...
    def __getstate__(self):
        return [self.path, self.size, self.index,
    ...
    def getlength(self, text, mode="", direction=None,
        ...
        return self.font.getlength(
            text, mode, direction, features, language) / 64
    ...
    def getsize(
        ...
        # see
        # https://github.com/python-pillow/Pillow/pull/4910#discussion_r486682929
        size, offset = self.font.getsize(
            text, "L", direction, features, language)
        return (
    ...
    def getsize_multiline(
        ...
        with warnings.catch_warnings():
            ...
            line_spacing = self.getsize(
                "A", stroke_width=stroke_width)[1] + spacing
            for line in lines:
    ...
    def get_variation_names(self):
        ...
        try:
            ...
            raise NotImplementedError(
                "FreeType 2.9.1 or greater is required") from e
...
class TransposedFont:
    ...
    def getbbox(self, text, *args, **kwargs):
        ...
        # this has no effect on ImageFont and simulates anchor="lt" for
        # FreeTypeFont
